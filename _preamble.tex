...
\ifdefined\AVECILLUSTRATIONS
  ...
  % Extrait musical inline : [#1]=espacement (défaut 0.8), #2=fichier dans music/, #3=légende
  \newcommand{\score}[3][0.66]{%
    \noindent\begin{minipage}{\linewidth}%
    \vspace{#1\onelineskip}%
    \lilypondfile[line-width=\linewidth,staffsize=12]{music/#2}%
    \begin{center}%
      \vspace{-#1\onelineskip}%
      {\centering\scriptsize{\textit{#3}}}%
      \vspace{#1\onelineskip}%
    \end{center}%
    \end{minipage}}
\else
