...
\ifdefined\AVECILLUSTRATIONS
  ...
  %   #4 = retrait symétrique gauche/droite (ex: 2cm, défaut: 0pt)
  %   #6 = légende commune (optionnelle)
  \NewDocumentCommand{\iconographiedouble}{O{b} O{5cm} m O{0pt} m O{}}{%
    \ifthenelse{\equal{#1}{b}}{\vspace*{\fill}}{\vspace*{0pt}}%
    \vspace{0.5\onelineskip}%
    {\setlength{\leftskip}{#4}\setlength{\rightskip}{#4}%
...
\else
  ...
  \NewDocumentCommand{\iconographiedouble}{O{bottom} O{5cm} m O{0pt} m O{}}{}
\fi
