...
\ifdefined\AVECILLUSTRATIONS
  ...
  % \iconographieinlineblock[placement]{\bwimage[width=W]{path}}{caption}[lines]
  ...
  \NewDocumentCommand{\iconographieinlineblock}{O{} m m O{1}}{%
    \ifx&#1&%
      % no placement → inline
    ...
    \else
      \ifthenelse{\equal{#1}{p}}{%
        ...
        \begingroup
          ...
          \ifx&#3&\else\addtolength{\iconofillheight}{-#4\baselineskip-0.5\baselineskip}\fi%
          \ifdim\iconofillheight>0pt
            \vspace{2\baselineskip}%
            \centerline{\resizebox*{!}{\iconofillheight}{#2}}%
            \ifx&#3&\else\par{\centering\figcaptionname\itshape#3\par}\fi%
          \fi
        \endgroup
      }{%
