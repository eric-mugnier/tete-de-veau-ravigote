  ...
  \newcommand{\iconographieinlineblock}[3][]{%
    ...
    \else
      \ifthenelse{\equal{#1}{p}}{%
        ...
        \par
        \begingroup
          \setlength{\@tempdima}{\dimexpr\pagegoal-\pagetotal\relax}%
          \ifx&#3&\else\addtolength{\@tempdima}{-1.5\baselineskip}\fi%
          \ifdim\@tempdima>0pt
            \centerline{\resizebox*{!}{\@tempdima}{#2}}%
            \ifx&#3&\else\par\centerline{\figcaptionname\itshape#3}\fi%
          \fi
        \endgroup
      }{%
