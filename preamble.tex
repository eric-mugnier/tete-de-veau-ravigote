...
\newcommand{\startnewchapter}[1][]{%
  \ifdefined\AVECNOTES
    ...
    {\centering\normalfont\scshape\large
      Notes~\textemdash~\Roman{actenum}~·~\arabic{scenenum}\par}%
    \vspace{\onelineskip}%
...
\makechapterstyle{gallimard}{%
  ...
  \renewcommand{\printchapternum}{%
    \chapnumfont\Roman{actenum}~·~\arabic{scenenum}%
    \markboth{\Roman{actenum}~·~\arabic{scenenum}}{\Roman{actenum}~·~\arabic{scenenum}}}
...
\newcommand{\startscene}{%
  ...
  \chapter{\Roman{actenum}~·~\arabic{scenenum}}%
