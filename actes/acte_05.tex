...
\textsc{Lui} : Des HGGP-9, pour Homemade Ghost Gun Pistol\nf{Un \textit{ghost gun} (littéralement «~pistolet fantôme~») est une arme à feu fabriquée artisanalement, sans numéro de série et donc non traçable. Avec l’avènement de l’impression 3D, leur fabrication s’est fortement démocratisée, posant un défi croissant aux autorités. \source{fr.wikipedia.org/wiki/Arme\_\%C3\%A0\_feu\_artisanale}} 9 mm, un pistolet 3D dont le modèle a été publié en open source sur le Dark Net par Colton Murray, un crypto-anarchiste d’extrême-droite, fondateur de la Division du Chaos, récemment condamné pour trafic d’armes, détention d’images pédopornographiques et agression sexuelle sur mineure.
