...
\textsc{Lui} : Un pistolet 9 mm, que j’ai fabriqué moi-même avec mon imprimante 3D\nf{Le \textsc{fgc}-9 (\textit{Fuck Gun Control}, calibre 9~mm) est une carabine semi-automatique dont la majeure partie des composants peut être produite par impression 3D. \source{fr.wikipedia.org/wiki/FGC-9}}.
