...
\begin{wrapfigure}[\dimexpr\textheight/\baselineskip\relax]{r}{0.42\textwidth}
  \illusloflabel{Hieronymus Bosch, Le Jardin des délices}%
...
\illusloflabel{Giotto, Le Baiser de Judas}%
...
\illusloflabel{Rosa Bonheur, Moutons au bord de la Mer}%
...
\illusloflabel{Dante Gabriel Rossetti, Lady Lilith}%
...
\illusloflabel{Red Hot Riding Hood}%
...
\illusloflabel{John William Waterhouse, Circé offrant la coupe à Ulysse}%
