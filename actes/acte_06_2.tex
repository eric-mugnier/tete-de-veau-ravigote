...
\illusloflabel{Dodge Charger}%
\iconographieinlineblock[b]{\bwimage[width=0.7\textwidth]{acte_06/scene_12/_0010_dodge.charger.png}}{Dodge Charger «~muscle car~», célèbre pour ses puissants moteurs V8}
...
Tous deux avaient des parfaites têtes d’abrutis comme on les aime, des lunettes de soleil sur le nez alors qu’on était en pleine nuit, la main sur le revolver et un sourire mauvais au coin du bec. C’était le genre sadique, cowboy mâchouilleur de chewing-gum comme on en croise sur les routes désertes du Texas, au volant d’une Dodge Charger\nf{Muscle car emblématique du groupe Chrysler (États-Unis), associé aux forces de l’ordre et à la culture du Sud depuis les années 1960.\source{fr.wikipedia.org/wiki/Dodge\_Charger}} gonflée à bloc, et qui n’hésitent pas à vous farcir de pruneaux au moindre pet de travers. 

%%% Il faut dire qu’ils s’emmerdent tellement que le fait de tomber sur un contrevenant représente pour eux une véritable aubaine. Ils seraient prêts à flinguer un coyote en train de traverser hors des clous.


\begin{dialogue}

\textsc{Le petit trapu} a dit : Messieurs-dames bonsoir. Contrôle des papiers, s’il vous plaît.

J’ai dit : Je suis de la maison, les gars.

\textsc{Le grand noueux} a dit : Dans ce cas, vous n’êtes pas sans savoir que les rassemblements sur la voie publique de nature à troubler l’ordre public sont interdits.

\textsc{Moi} : On ne trouble rien du tout. Et oui, merci, je suis au courant, article 431\nf{L’article 431-1 du Code pénal français réprime la participation à des attroupements malgré les sommations de dispersion.\source{fr.wikipedia.org/wiki/Code\_pénal\_français}} du code de procédure pénale.
...
\textsc{Le petit trapu}, le flingue braqué sur moi : Alors allez-y. Mais en douceur, s’il vous plaît.
...
\textsc{Le grand noueux}, après avoir examiné le document sous toutes les coutures : Toutes mes excuses, mon commandant. Mais avec les trucs bizarres qu’on voit en ce moment, on est obligé de prendre toutes les précautions.
...
\textsc{Moi} : Vous avez mille fois raison, les gars. On ne serait pas dans cette merde s’il y avait plus de jeunes comme vous. Hélas, la plupart ne pensent plus qu’à faire la fête, boire de l’alcool et consommer de la drogue. Les zones de non-droit se multiplient et les honnêtes gens n’osent plus sortir de chez eux de peur de se faire agresser ou prendre une balle perdue.
...
\textsc{Moi} : Pas du tout, mon garçon. Je suis content de voir qu’on peut s’appuyer sur des gars comme vous pour faire régner l’ordre dans cette putain de ville. On n’est pas encore à Gotham City\nf{Ville fictive de l’univers DC Comics, cadre des aventures de Batman ; métaphore d’une mégalopole criminelle et corrompue.\source{fr.wikipedia.org/wiki/Gotham\_City}}, mais on ne va pas tarder à y arriver si personne ne prend les choses en main.
...
\illusloflabel{}%
\iconographiewrapfig{r}{0.48\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0000_moldavie.jpg}}{Moldavie}%
%
...
\noindent Il s’est rétracté dans le fond de sa coquille comme un es\-car\-got ébouillanté.

\begin{dialogue}

J’ai enchaîné, sans me soucier des bâillements et autres signes d’ennui dispensés par mon auditoire : Quoi qu’il en soit, mon cher Darian, Darwin\nf{Charles Darwin (1809--1882), naturaliste britannique, auteur de \textit{L’Origine des espèces} (1859), ouvrage fondateur de la théorie de l’évolution par sélection naturelle. Sa \textit{Filiation de l’homme et la sélection liée au sexe} (1871) étend la théorie évolutive à l’espèce humaine et traite notamment des peuples primitifs et de la sélection sexuelle. \source{fr.wikipedia.org/wiki/Charles\_Darwin}} lui-même, dans sa Filiation de l’homme et la sélection liée au sexe, en parle de façon très élogieuse. Les San, noble peuple s’il en est, descendent d’une population fantôme vieille de plusieurs centaines de milliers d’années. Leur ADN contient des haplogroupes mitochondriaux appartenant à la Mère de toutes les mères, celle dont le ventre primordial a enfanté l’espèce humaine au sens noble du terme. Le généticien japonais Kudo Naonori, professeur à l’université de Sendai, membre honoraire de la Royal Society de Londres et spécialiste de l’évolution des espèces, auteur d’ouvrages de référence sur la théorie de la coalescence et la dérive génétique, a dressé un arbre généalogique complet de tous les locus polymorphes connus. Ce dernier indique on ne peut plus clairement que les origines de l’Homme moderne ne remontent pas à quelques deux cent mille ans, comme on le pensait depuis la découverte des squelettes de la basse vallée de l’Omo\nf{Les fossiles de la basse vallée de l’Omo (Éthiopie), découverts en 1967 par Richard Leakey, sont des restes d’\textit{Homo sapiens} datés d’environ 195\,000 ans (Omo I et II). Ils constituaient jusqu’à récemment les plus anciens fossiles connus de notre espèce. \source{fr.wikipedia.org/wiki/Homme\_de\_Kibish}}, mais à plus de trois cent mille. Quelques rares ossements, dont un crâne quasiment complet, ont été retrouvés dans une mine de barytine de la province de Youssoufia\nf{Le site de Djebel Irhoud, découvert en 1961 dans une mine de barytine près de Youssoufia (Maroc), a livré des restes d’\textit{Homo sapiens} datés d’environ 300\,000 ans, repoussant ainsi l’origine de notre espèce bien au-delà des estimations précédentes. \source{fr.wikipedia.org/wiki/Djebel\_Irhoud}}, au Maroc, en compagnie de nombreux outils en pierre taillée de facture très avancée. Si vous aviez traversé autant d’épreuves au cours de votre existence, peut-être que vous aussi auriez une façon un peu «~bizarre~» de considérer vos semblables.

\iconographietex{figures/origines-de-l-homme-moderne_fig.tex}
\textsc{Lisnic}, à la fois ému par le fait que pour une des rares fois de sa vie quelqu’un s’adressait à lui comme à autre chose que l’abruti de première qu’il n’avait jamais cessé d’être, allant même jusqu’à pousser le vice d’en concevoir une certaine fierté de classe, et agacé par celui d’être une fois de plus confronté à l’immensité océanique du désastre culturel dont il était l’un des plus fidèles représentants : Z’êtes un vrai puits de science, mon commandant.

\textsc{Moi} : Tu l’as dit, bouffi.

\textsc{Lui}, tête baissée tel un collégien qui vient de se faire méchamment remonter les bretelles par son paternel après avoir récolté un zéro en maths assorti de commentaires peu élogieux sur sa conduite au sein de l’établissement : Désolé, je voulais pas vous froisser. C’est juste que quand je les ai vus se barrer en loucedé, elle et son compagnon, je me suis dit qu’ils avaient peut-être des choses à cacher.
...
\textsc{Moi} : Tu veux dire du Mésozoïque\nf{Le Mésozoïque est une ère géologique s’étendant d’environ 252 à 66~millions d’années avant notre ère, subdivisée en trois périodes~: le Trias, le Jurassique et le Crétacé. Surnommée «~l’ère des reptiles~», elle vit l’apogée des dinosaures, des reptiles marins et des premiers mammifères. \source{fr.wikipedia.org/wiki/Mésozoïque}}.

\illusloflabel{Office Chérifien des Phosphates}%
\iconographieinlineblock[b]{\bwimage[width=\textwidth]{acte_06/scene_12/_0080_office-chérifien-des-phosphates-de-safi.jpg}}{Office Chérifien des Phosphates · Safi · Maroc} 

\textsc{Lui} : Oui, peut-être. Toujours est-il que mon père est originaire du coin. Après avoir été longtemps chercheur d’or à Tichla, dans le Sahara occidental, et vendu des dents de fossiles aux touristes pour arrondir ses fins de mois, il a fini agent de sécurité à l’OCP, l’Office Chérifien des Phosphates de Safi\nf{Le Groupe OCP, fondé en 1920 et dont le siège est à Rabat, est le premier exportateur mondial de phosphates et de dérivés phosphatés. Le Maroc détient environ 70~\% des réserves mondiales connues de phosphates. \source{fr.wikipedia.org/wiki/Groupe\_OCP}}, plus gros producteur de phosphates du monde.

\textsc{Moi}, de la docte voix de l’enseignant qui s’adresse à un amphithéâtre plein à craquer d’étudiants avides de boire son jus vocal jusqu’à la dernière gorgée syllabique : Ton histoire m’a ému aux larmes, mon petit Barkad, et je crois que je ne suis pas le seul. Maintenant, si tu veux mon sentiment sur le sujet qui nous occupe, à savoir est-ce que l’homme de loi jouit d’une hypersensibilité particulière pour tout ce qui est bizarre, insolite, inhabituel, eh bien sache que ma réponse est oui, sans aucun doute. C’est dans sa nature. Dès qu’un truc sort de l’ordinaire, il le renifle à des lieues à la ronde, comme un requin qui a flairé l’odeur du sang.
...
\illusloflabel{\textit{Vingt mille lieues sous ta mère}}%
\iconographiewrapfig{l}{0.52\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0100_vingt-mille-lieues-sous-ta-mère.jpg}}{}%
%
Il parlait de Sam, toujours en train de bâiller aux corneilles avec un air bienheureux d’idiot du village pour qui chaque brin de muguet, oisillon tombé du nid ou hérisson écrasé au bord de la route représente une source d’émerveillement digne des \textit{Mille et une nuits}\nf{Recueil de contes du Proche et Moyen-Orient compilé principalement entre le VIIIe et le XIVe siècle, transmis en Europe grâce à la traduction d’Antoine Galland (1704--1717).\source{fr.wikipedia.org/wiki/Les\_Mille\_et\_Une\_Nuits}}, \textit{Vingt mille lieues sous ta mère}\nf{\textit{Vingt Mille Lieues sous les mers} (1870), roman de Jules Verne mettant en scène le capitaine Nemo à bord du \textit{Nautilus}. L'un des textes fondateurs de la science-fiction. \source{fr.wikipedia.org/wiki/Vingt\_Mille\_Lieues\_sous\_les\_mers}} et tous les autres trucs avec mille dans le titre\nf{Liste non exhaustive d'œuvres dont le titre contient le mot «~mille~» ou un multiple, toutes langues et genres confondus~:
\begin{list}{}{%
  \setlength{\topsep}{2pt}%
  ...
  \item \textit{Les Mille et Une Nuits} --- Anonyme --- 1704--1717
  \item \textit{Mille et un fantômes} --- Alexandre Dumas --- 1849
  \item \textit{Vingt mille lieues sous les mers} --- Jules Verne --- 1870
  \item \textit{Les mille douzaines} --- Jack London --- 1903
  \item \textit{Cent mille milliards de poèmes} --- Raymond Queneau --- 1961
  \item \textit{Mille plateaux} --- Gilles Deleuze et Félix Guattari --- 1980
  \item \textit{Mille femmes blanches} --- Jim Fergus --- 1998
  \item \textit{Mille ans de bons souhaits} --- Yiyun Li --- 2005
  \item \textit{Mille soleils splendides} --- Khaled Hosseini --- 2007
  \item \textit{Les mille automnes de Jacob de Zoet} --- David Mitchell --- 2010
  \item \textit{Mille petits riens} --- Jodi Picoult --- 2016
  \item \textit{Mille secrets, mille dangers} --- Alain Farah --- 2022
\end{list}}.
...
\textsc{Achaari} : Je connais, mon cousin y a travaillé comme serveur. 

\textsc{Sally} : Et il s’appelle comment, votre cousin ?
...
\textsc{Sally} : Et je ne parle pas du reste.
...
\textsc{Moi}, sentant venir le drame : Oui, je me paluche pas mal mais je ne suis pas encore sourd. Le problème, voyez-vous, c’est qu’on est dans un pays libre. Chacun a le droit de s’exprimer comme il l’entend, avec les mots qui sont les siens.
...
\textsc{Sally} : … monsieur le brigadier-chef, pardon : parce qu’il avait besoin d’aller dans les loges pour se changer, comme tout le monde.
...
\textsc{Sally}, d’une voix exprimant clairement son exaspération : Oui, mais dans notre établissement même les serveurs ont droit à une tenue particulière. C’est comme dans les clubs Playboy\nf{Chaîne de clubs nightlife fondée par Hugh Hefner en 1960, célèbre pour ses hôtesses (Bunny Girls) en costume de lapin ; icône de la culture populaire américaine des années 1960--1980.\source{fr.wikipedia.org/wiki/Playboy\_Club}} : les Bunnies portent un costume de lapin sexy avec corset, nœud pap, oreilles et queue de lapin. Eh bien chez nous c’est pareil : les serveurs portent une tenue de service.
...
\illusloflabel{Boxer en latex avec étui pénien}%
\iconographiewrapfig{r}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0000_boxer-en-latex-avec-étui-pénien.png}}{}%
%
...
\textsc{Sally} : Écoutez, monsieur l’agent brigadier-machin-chose, les mœurs sont très libres au Sugar \& Spice, et il n’est pas rare que nous prenions nos douches en commun. Les sportifs font ça régulièrement, on n’en fait pas tout un plat.
...
\textsc{Moi} : Messieurs, je ne voudrais pas abuser de mes prérogatives, mais en tant que votre supérieur hiérarchique, je pense en effet que la comédie a assez duré. Vous admettrez que vos agissements sont assez peu en rapport avec la procédure habituelle. En clair, si vous continuez à nous casser les couilles au lieu de faire le boulot pour lequel le contribuable vous rémunère, je me verrai dans l’obligation d’en référer à qui de droit. Suis-je clair ?
...
\textsc{Greg} s’est aussitôt porté à son chevet : Sam ? Ça va ?
...
\textsc{Sally}, à Sam : \shouting{Homophobe !}

\textsc{Sam} : \shouting{Ta gueule, le travelo !}

\textsc{Sally} : \shouting{Trisomique !}
...
\illusloflabel{Pierre Thau}%
\iconographiewrapfig{l}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0130_pierre_thau.jpg}}{Pierre Thau \\[-3pt] \textup{1933--2000}}%
%
\textsc{Moi}, avec la voix de Pierre Thau\nf{Pierre Thau (1932--2013), baryton-basse français, pensionnaire de l’Opéra de Paris pendant plus de trente ans. Spécialiste des grands rôles de basse du répertoire lyrique : Méphisto (\textit{Faust} de Gounod), Don Quichotte (Massenet), la statue du Commandeur et Don Giovanni (Mozart), le Comte des Grieux (Massenet), Don Pedro (\textit{L’Africaine} de Meyerbeer). \source{fr.wikipedia.org/wiki/Pierre\_Thau}}, inoubliable interprète des plus grands rôles de basse du répertoire (Méphisto\nf{Méphisto, personnage du diable dans \textit{Faust}, opéra en cinq actes de Charles Gounod (1859). \source{fr.wikipedia.org/wiki/Faust\_(Gounod)}}, Don Quichiotte\nf{Don Quichotte, opéra en cinq actes de Jules Massenet (1910), d'après le roman de Cervantes. \source{fr.wikipedia.org/wiki/Don\_Quichotte\_(opéra)}}, la statue du Commandeur\nf{La statue du Commandeur (Il Commendatore), personnage de \textit{Don Giovanni}, opéra en deux actes de Wolfgang Amadeus Mozart (1787). \source{fr.wikipedia.org/wiki/Don\_Giovanni}}, le Comte des Grieux\nf{Le Comte des Grieux, rôle de basse (le père), dans \textit{Manon}, opéra en cinq actes de Jules Massenet (1884). \source{fr.wikipedia.org/wiki/Manon\_(opéra)}} et Don Pedro\nf{Don Pedro, personnage de \textit{L'Africaine}, opéra en cinq actes de Giacomo Meyerbeer (1865). \source{fr.wikipedia.org/wiki/L'Africaine}}, pour ne citer que les plus fameux) : \shouting{Vous allez les fermer vos grandes gueules, oui ou merde !!!!!!!!!!!!!! Nom de dieu de bordel de merde !!!!!!!!!! Je commence vraiment à en avoir plein le cul de vos conneries !!!!!!!!!!!!!!}
...
\textsc{Achaari} : Hamdullah\nf{Abréviation de Alhamdulillah (en arabe~: \arab{ٱلْحَمْدُ لِلَّٰهِ}, « Louange à Dieu »), expression d’action de grâce très répandue dans les pays arabophones et parmi les musulmans du monde entier.\source{fr.wikipedia.org/wiki/Alhamdoulillah}} !
...
\illusloflabel{Molière}%
\iconographiewrapfig{r}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0200_molière.png}}{Jean-Baptiste Poquelin, dit Molière \\[-3pt] \textup{1622--1673}}%
%
\textsc{Moi} : Je dois reconnaître que vous avez idéalement narré la chose, mon ami.

\textsc{Greg} : Quel talent !

\textsc{Sarah} : C’est pas tous les jours qu’on croise un flic moldave qui maîtrise aussi bien la langue de Molière\nf{Expression désignant la langue française, par référence à Jean-Baptiste Poquelin dit Molière (1622--1673), dramaturge et comédien considéré comme le maître de la comédie classique française.\source{fr.wikipedia.org/wiki/Molière}}.
...
\textsc{Sally}, après un ricanement d’une méchanceté absolue, ce genre de ricanement sardonique d’où toute humanité semble avoir été effacée par la main même de Satan : Bosser !!! Laissez-moi rire !

\illusloflabel{Simone de Bavoir et Jean-Paul Tartre}%
\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_06/scene_12/_0210_simone-de-bavoir-et-jean-paul-tartre.jpg}}{Simone de Bavoir \textup{1908--1986} · Jean-Paul Tartre \textup{1905--1980}} 

\textsc{Greg}, prêt à fondre sur sa proie telle la harpie féroce sur le paresseux tridactyle assoupi dans la jungle guyanaise (ou~-- pour reprendre une expression chère à Simone de Bavoir\nf{Simone de Beauvoir (1908--1986), écrivaine et philosophe française, figure majeure de l’existentialisme et du féminisme. Auteure notamment du \textit{Deuxième Sexe} (1949) et des \textit{Mémoires d’une jeune fille rangée} (1958). Compagne de Jean-Paul Sartre, elle fut surnommée «~le Castor~» par ce dernier. \source{fr.wikipedia.org/wiki/Simone\_de\_Beauvoir}}, alors qu’elle n’était pas encore le castor de Jean-Paul Tartre\nf{Jean-Paul Sartre (1905--1980), philosophe, écrivain et dramaturge français, figure tutélaire de l’existentialisme. Auteur de \textit{L’Être et le Néant} (1943), \textit{La Nausée} (1938) et \textit{Les Mains sales} (1948). Il refusa le prix Nobel de littérature en 1964. \source{fr.wikipedia.org/wiki/Jean-Paul\_Sartre}}~-- le jaguar richement orné sur le stylistiquement insignifiant pécari à lèvres blanches, bien trop occupé à retourner bruyamment la terre avec son groin humide pour se rendre compte du danger qui le menace) : Je vais buter cette salope !
...
\textsc{Sam}, après qu’un vol de corbeaux a traversé le ciel nuageux de son cerveau : Euh… si, plus ou moins, mais je tiens pas forcément à ce que tout le monde le sache.
...
\textsc{Moi} : C’est sans doute pour ça qu’il n’a pas fait carrière dans l’armée.
...
\illusloflabel{Jeffrey Dahmer}%
\iconographiewrapfig{l}{0.35\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0230_jeffrey-dahmer.png}}{Jeffrey Dahmer \\[-3pt] \textup{1960--1994}}%
%
\textsc{Greg} : Ouais, comme Jeffrey Dahmer\nf{Jeffrey Dahmer (1960--1994), tueur en série américain surnommé «~le Cannibale de Milwaukee~». Il assassina dix-sept hommes entre 1978 et 1991, pratiquant sur ses victimes démembrement, nécrophilie et cannibalisme. Ses premières pulsions violentes sur les animaux dans l’enfance sont documentées par les enquêteurs. Condamné à quinze réclusions à perpétuité, il fut tué en prison en 1994. \source{fr.wikipedia.org/wiki/Jeffrey\_Dahmer}} !
...
\textsc{Elle} s’est arrêtée, retournée, et a rétorqué d’une voix étouffée par la rage et la déception : Je crois que je n’ai plus rien à faire ici.
...
\textsc{Moi} : C’est comme ça que je vois les choses. En attendant, s’il n’est pas rentré à la maison à la première heure, Bérénice va me tomber dessus et je vais avoir toutes les peines du monde à lui expliquer ce qui s’est réellement passé.
...
\illusloflabel{}%
\iconographiewrapfig{r}{0.17\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_12/_0000_gurkha-ghost-spook.jpg}}{Gurkha Ghost Spook}%
%
En tant qu’homme moderne parfaitement connecté au monde réel et toujours au fait des dernières avancées en matière de technologies de pointe, \textsc{Greg} a aussitôt sorti son smartphone, appareil sur lequel il disposait de toutes les applis nécessaires pour quadriller le périmètre au dixième de millimètre près : Attends, je regarde s’il y en a un dans le coin.
...
\illusloflabel{Hamdullah!}%
\iconographieinlineblock[b]{\bwimage[width=0.55\textwidth]{acte_06/scene_12/_0190_hamdullah.jpg}}{}%
