...
Il y a ce qu’on appelle la «~loi des séries~», comme si le destin vous imposait une thématique à laquelle il semble impossible de déroger.

\illusloflabel{}%
Assez loin de ces considérations, tous les dimanches matin, aux premières lueurs de l’aube, Robert Pleimelding allait à la chasse. Avec sa fidèle Greta, un braque allemand à poil dur qu’il appelait «~ma fille~» ou \iconographiewrapfig{l}{0.66\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0000_braque-allemand-a-poil-dur.jpg}}{Braque allemand à poil dur}«~fifille~», alors même qu’il avait déjà une fille, une vraie, avec laquelle il n’échangeait guère plus de trois ou quatre mots par an, et encore seulement les bonnes années.
...
\illusloflabel{Artemisia Gentileschi, \textit{Autoportrait en joueuse de luth}}%
\iconographieimg[1]{acte_04/scene_6/_0000_luth_artemisia-gentileschi.jpg}{Artemisia Gentileschi \textup{1593--1656}\\ [-3pt] Autoportrait en joueuse de luth \textup{1618}}

Robert avait trouvé son employeur au coin du feu, nu sous une robe de chambre élimée dans le genre de celles que portaient les aristos des temps jadis, luth en main. Quand je parle de luth, je ne parle pas de lutte gréco-romaine mais de vrai luth, cette sorte de guitare du Moyen Âge qui a plus ou moins la forme d’une larme ou une goutte d’eau, l’instrument dont un Bernard de Ventadour\nf{Bernard de Ventadour (v.~1130--v.~1200), troubadour limousin considéré comme l’un des plus grands poètes occitans du \textsc{xii}\textsuperscript{e}~siècle, célèbre pour ses chansons d’amour courtois adressées à des dames de haute noblesse. \source{fr.wikipedia.org/wiki/Bernard\_de\_Ventadour}} se servait pour enchanter la belle Aliénor d’Aquitaine\nf{Aliénor d’Aquitaine (v.~1122--1204), duchesse d’Aquitaine et reine successivement de France (épouse de Louis~VII) puis d’Angleterre (épouse d’Henri~II Plantagenêt). Grande mécène des troubadours, elle est l’une des figures politiques les plus puissantes du Moyen Âge occidental. \source{fr.wikipedia.org/wiki/Aliénor\_d'Aquitaine}} à la cour du roi de France.
...
%%% Cohiba Esplendidos Gran Reserva
...
Et donc, comme je vous le disais, cette agréable demeure, il la quittait tous les dimanches matin pour aller à la chasse avec Greta, sa chienne, acquise elle aussi avec cet héritage ; tout comme, du reste, le juxtaposé Chapuis Progress Grand Luxe\nf{Fusil de chasse juxtaposé de très haute facture artisanale fabriqué par la manufacture Chapuis Armes, fondée en 1921 à Saint-Bonnet-le-Château (Loire). L’une des maisons d’armes fines les plus réputées de France.\source{fr.wikipedia.org/wiki/Chapuis\_Armes}} calibre 12/70 (crosse anglaise en noyer premier choix, plaque de couche en bois de rose et sujets animaliers gravés en taille douce sur les contre-platines et le dessous de bascule, grosse émotion) qu’il chérissait comme la prunelle de ses yeux et passait des heures à lustrer en écoutant des opérettes de Jacques Offenbach\nf{Jacques Offenbach (1819--1880), compositeur et violoncelliste franco-allemand, créateur de l’opéra-bouffe français. Auteur de plus de cent opérettes, dont \textit{La Belle Hélène} (1864), \textit{Orphée aux Enfers} (1858) et \textit{Les Contes d’Hoffmann} (posth., 1881). \source{fr.wikipedia.org/wiki/Jacques\_Offenbach}}, Reynaldo Hahn\nf{Reynaldo Hahn (1874--1947), compositeur, chef d’orchestre et critique musical vénézuélo-français, ami intime de Marcel Proust. Connu pour ses mélodies et ses opérettes, notamment \textit{Ciboulette} (1923) et \textit{Mozart} (1925). \source{fr.wikipedia.org/wiki/Reynaldo\_Hahn}} et Francis Lopez\nf{Francis Lopez (1916--1995), compositeur français spécialiste de l’opérette populaire, auteur de \textit{La Belle de Cadix} (1945) et \textit{Le Chanteur de Mexico} (1951), qui connurent un succès considérable dans l’après-guerre. \source{fr.wikipedia.org/wiki/Francis\_Lopez}}.

\score{galop-infernal.ly}{Jacques Offenbach · Orphée aux enfers · Galop infernal}
...
\illusloflabel{}%
Ce matin-là, donc (je ne sais pas si je vais y arriver), aux aurores, Greta (folle de joie à l’idée d’aller se dégourdir les papattes en forêt), Robert, sa gibecière à rabat en cuir pleine fleur Lazzaro Bernardini\nf{Maison italienne de maroquinerie artisanale spécialisée dans les accessoires de chasse de prestige (gibecières, carnassières, porte-fusils), peu connue hors du cercle des chasseurs éclairés.} (dans les deux mille euros sur plaisirsdelachiasse.com), son fusil Chapuis de collection, \iconographiewrapfig{l}{0.5\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0120_land-cruiser.jpg}}{Toyota Land Cruiser}un thermos de café, des vivres pour midi (dont une belle grosse gourdasse d’un Hautes-Côtes de Nuits\nf{Appellation viticole AOC bourguignonne en Côte-d’Or, produisant des vins rouges (Pinot noir) et blancs (Chardonnay) dans les collines dominant la Côte de Nuits. Moins cotés que leurs voisins de la Côte, ces vins offrent un excellent rapport qualité-prix.\source{fr.wikipedia.org/wiki/Hautes-côtes-de-nuits}} somme toute assez gouleyant), et assez de cartouches pour soutenir un siège face au GIGN, sont tous montés dans le Land Cruiser\nf{Toyota Land Cruiser, SUV tout-terrain japonais produit sans interruption depuis 1951. Reconnu pour sa fiabilité extrême dans les conditions les plus difficiles, il est devenu un symbole de robustesse dans le monde rural et les régions isolées.\source{fr.wikipedia.org/wiki/Toyota\_Land\_Cruiser}} que ce même Robert, toujours lui, s’était offert avec le pognon de Bellisle. Robert s’est installé au volant, Greta à ses côtés (elle préférait monter devant), a tourné la clé de contact, le 4x4 a hoqueté quelques instants avant de faire entendre la douce musique de son six cylindres en ligne, puis tout ce joli petit monde a pris le chemin des quelques cinquante hectares de forêt que cet enfoiré de Robert, encore et toujours lui, avait également hérité de son bienfaiteur. Une belle journée s’annonçait, pleine de soleil et de ciel bleu, et avec elle la promesse d’une partie de chasse réussie quel que soit le résultat des courses. Même s’il fallait se contenter d’un lapin ou deux, avec en prime une perdrix et quelques cèpes, la joie de se balader au grand air, en toute liberté, avec Greta gambadant à ses côtés, l’œil vif et la truffe au ras du sol, attentive au moindre bruit, au moindre frémissement, et surtout personne pour vous poser des questions idiotes et vous débiter des inepties dans les oreilles, suffirait amplement à son bonheur.
...
Sous le choc, Robert prenait lentement conscience que sa partie de chasse venait de prendre un tour tragique. Car ici même, dans son bois à lui, sa \textsc{Propriété Privée} dûment signalée par de nombreux panneaux d’avertissement de couleur vive, une personne avait été réduite en cendres par une ou plusieurs autres, le tout sans aucune autorisation, dans le plus total mépris de la législation en vigueur et la propriété d’autrui.
...
\iconographietex{figures/couples_fig.tex} %
%
...
\illusloflabel{Peter Falk}%
\iconographiewrapfig{r}{0.36\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0210_columbo.jpg}}{Peter Falk (Inspecteur Columbo) \\[-3pt] \textup{1927--2011}}%
...
Là encore j’avais parfaitement compris, mais j’appliquais la méthode Columbo\nf{L’inspecteur Columbo, héros de la série télévisée américaine (\textit{Columbo}, NBC/ABC, 1968--2003), interprété par Peter Falk. Créé par Richard Levinson et William Link, il est célèbre pour sa tactique de fausse naïveté : désarmer l’adversaire par son apparence négligée avant de lui asséner la question fatale.\source{fr.wikipedia.org/wiki/Columbo}} (l’imper cradingue, le basset pétomane et le strabisme en moins), qui consiste à se faire passer pour une bille afin d’endormir la méfiance du suspect.
...
\illusloflabel{Girolles}%
\iconographiewrapfig{r}{0.55\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0000_girolles.jpg}}{}%
\illusloflabel{Paul-Claude Racamier}%
Naturellement, je savais parfaitement qu’il s’agissait de girolles. Là encore, je travaillais mon personnage d’idiot de service pour mettre le suspect en confiance et l’inciter à se trahir. Suspect qui n’avait d’ailleurs à priori rien de suspect, si ce n’est qu’il avait soi-disant découvert le corps sur un terrain lui appartenant. Je suis d’accord que ce n’était pas comme s’il l’avait trouvé dans son salon en rentrant chez lui après une dure journée de labeur. Les traces d’effraction qu’on n’aurait pas manqué de remarquer auraient joué en sa faveur (même s’il aurait très bien pu les fabriquer lui-même), et les relevés de scène de crime auraient été autrement plus aisés qu’en pleine forêt. Ici, en dépit des interdictions placardées un peu partout, n’importe qui pouvait introduire à sa guise, en particulier la nuit, et s’adonner en toute tranquillité à des activités peu recommandables. Cela dit, quand quelqu’un appelle les flics pour leur signaler un meurtre, il y a toujours ce vieux réflexe conditionné qui les incite à placer l’intéressé en tête de liste des suspects. \label{rat:20}On ne manque pas d’exemple où l’assassin, non content d’avoir lui-même attiré l’attention de la police sur l’événement, se montre exagérément coopératif auprès des forces de l’ordre, allant parfois jusqu’à mener sa propre enquête. Cela traduit non seulement une faille psychologique importante, sinon une «~catastrophe psychique~» telle que définie par Racamier\nf{Paul-Claude Racamier (1924--1996), psychiatre et psychanalyste français. Figure majeure de la psychanalyse française, il est notamment connu pour ses travaux sur la psychose, le narcissisme et les processus d’emprise, ainsi que pour avoir introduit le concept d’«~antinarcissisme~». \source{fr.wikipedia.org/wiki/Paul-Claude\_Racamier}} dans son article intitulé «~Entre agonie psychique, déni psychotique et perversion narcissique~»\nf{«~Entre agonie psychique, déni psychotique et perversion narcissique~», article de Paul-Claude Racamier publié en 1986 dans la \textit{Revue Française de Psychanalyse}. Il y développe le concept de perversion narcissique, désignant un mode de fonctionnement psychique fondé sur le déni de la réalité et l’emprise sur autrui. \source{revue-psy.fr/2023/02/16/entre-agonie-psychique-deni-psychotique-et-perversion-narcissique/}} publié en 1986 dans la \iconographiewrapfig{l}{0.36\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0220_racamier.jpg}}{Paul-Claude Racamier \\[-3pt] \textup{1924--1996}}Revue Française de Psychanalyse\nf{La \textit{Revue française de psychanalyse} est une publication scientifique fondée en 1927, organe officiel de la Société psychanalytique de Paris (SPP). Elle publie des travaux théoriques et cliniques en psychanalyse. \source{fr.wikipedia.org/wiki/Revue\_française\_de\_psychanalyse}}, mais aussi la volonté de coller au plus près de l’enquête pour tenter de la manipuler à son profit.
...
\illusloflabel{\textit{Le Vieux Fusil}}%
\iconographiewrapfig{r}{0.44\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0270_le-vieux-fusil.jpg}}{Le Vieux Fusil \textup{1975}}%
%
\textsc{Pleimelding} : Je suppose que vous voulez parler de Julien Dandieu\nf{Julien Dandieu, personnage central du \textit{Vieux fusil} (1975) de Robert Enrico, interprété par Philippe Noiret. Chirurgien français qui, après le massacre de sa femme Clara et de leur fille par des SS en 1944, se venge seul de manière implacable. Le film est resté célèbre pour la scène du lance-flammes et la réplique~: «~Tu vois, Julien, c’est ça la chevrotine.~» \source{fr.wikipedia.org/wiki/Le\_Vieux\_Fusil}}, dans \textit{Le vieux fusil}\nf{Film français réalisé par Robert Enrico (1975), avec Philippe Noiret et Romy Schneider. Un chirurgien alsacien se venge seul des SS qui ont massacré sa femme et sa fille en 1944. César du meilleur film en 1976.\source{fr.wikipedia.org/wiki/Le\_Vieux\_Fusil}}.
...
\textsc{Pleimelding} : Il voulait parler du Vieux fusil, un film de Robert Enrico\nf{Robert Enrico (1931--2001), réalisateur français, auteur notamment du \textit{Vieux fusil} (1975), film sur la vengeance d’un chirurgien dont la femme a été massacrée par les SS en 1944. Cinq César, dont meilleur film, meilleur acteur (Noiret) et meilleur second rôle. \source{fr.wikipedia.org/wiki/Robert\_Enrico}} avec Romy Schneider\nf{Romy Schneider (1938--1982), actrice austro-française, icône du cinéma européen des années 1960--1970. Elle incarne Clara Dandieu dans \textit{Le Vieux fusil} (1975) et reste célèbre pour la trilogie \textit{Sissi} et sa collaboration avec Claude Sautet. \source{fr.wikipedia.org/wiki/Romy\_Schneider}} et Philippe Noiret\nf{Philippe Noiret (1930--2006), acteur français majeur, interprète de Julien Dandieu dans \textit{Le Vieux fusil} (1975, César du meilleur acteur). Également connu pour \textit{Cinema Paradiso} (1988) et \textit{Il Postino} (1994). \source{fr.wikipedia.org/wiki/Philippe\_Noiret}}.

\illusloflabel{Romy Schneider}%
\iconographieinlineblock[]{\bwimage[width=0.9\textwidth]{acte_04/scene_6/_0290_romy-schneider_3.jpg}}{Romy Schneider \textup{1938--1982}, dans \textup{Le Vieux fusil}}
...
\textsc{Moi} : Eh bien des années plus tard, en juin 44, Clara, la femme de Julien Dandieu, alias Romy Schneider et Philippe Noiret comme a eu la délicatesse de nous le rappeler notre hôte, est assassinée par des Nazis en déroute, dans le genre Oradour-sur-Glane\nf{Oradour-sur-Glane, village de Haute-Vienne où, le 10~juin 1944, des soldats de la division SS \textit{Das Reich} massacrent 643~habitants, dont des femmes et des enfants enfermés dans l’église et brûlés vifs. Le village martyr est conservé en l’état et classé monument historique. \source{fr.wikipedia.org/wiki/Massacre\_d'Oradour-sur-Glane}}.

\illusloflabel{La division \textit{Das Reich} en juin 1944}%
\iconographieimg[1]{acte_04/scene_6/_0310_oradour_das_reich.png}{}
...
\illusloflabel{Totenkopf}%
\textsc{Moi} : Et si c’est comme dans Le vieux fusil, peut-être qu’il faut se pencher sur la piste d’un sympathisant d’extrême-droite, un nostalgique du \iconographiewrapfig{r}{0.2\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_6/_0340_totenkopf.png}}{}IIIe Reich, de la Schutzstaffel\nf{La \textit{Schutzstaffel} (SS, «~escadron de protection~») fut fondée en 1925 comme garde personnelle d’Hitler avant de devenir l’organe central de la terreur nazie~: camps de concentration, Gestapo, Einsatzgruppen. À son apogée, elle comptait près d’un million de membres. \source{fr.wikipedia.org/wiki/Schutzstaffel}}, Das Reich\nf{La 2\textsuperscript{e}~division SS \textit{Das Reich}, division blindée de la Waffen-SS, est responsable du massacre d’Oradour-sur-Glane (10 juin 1944) et de celui de Tulle (9 juin 1944). Elle figura parmi les unités les plus décorées et les plus criminelles du \textsc{iii}\textsuperscript{e}~Reich. \source{fr.wikipedia.org/wiki/2e\_division\_SS\_Das\_Reich}} et la division Totenkopf\nf{La 3\textsuperscript{e}~division SS \textit{Totenkopf} («~Tête de mort~») fut formée en 1939 à partir des gardiens des camps de concentration. Elle commit de nombreux crimes de guerre sur le front de l’Est et en France (massacre de Le Paradis, 1940). \source{fr.wikipedia.org/wiki/3e\_division\_SS\_Totenkopf}}, membre d’un de ces quelconques groupuscules néo-nazis qui poussent comme des champignons vénéneux sur le terreau de la connerie humaine ! Peut-être qu’il a un portrait de Hitler dans sa chambre, fréquente les sites de militaria sur le dark web et écoute des chants nazis dans son sous-sol de sa maison transformé en QG de la Kommandantur. Et dans ce cas, la victime était peut-être juive, communiste, gay, handicapée mentale, ou les quatre à la fois !

\textsc{Lui} : Oui, enfin, je trouve quand même que tu fais une fixette sur les Nazis. Ils ne sont pas les seuls à avoir utilisé le lance-flammes, arme de guerre aujourd’hui passée de mode mais très répandue à l’époque. Les Américains, par exemple, s’en sont servi en Corée et au Vietnam\nf{Les États-Unis employèrent massivement les lance-flammes dans ces deux conflits : en Corée (1950--1953) pour déloger les soldats des bunkers, et au Vietnam (1955--1975) notamment via les bombardements au napalm. Leur usage contre des populations civiles reste l’un des aspects les plus controversés de ces guerres.\source{fr.wikipedia.org/wiki/Guerre\_de\_Corée}}.

\illusloflabel{Lance-flammes de la Boring Company}%
\textsc{Moi} : N’empêche que si ça s’est vraiment passé comme je le pense, on aurait tout intérêt à aller fouiner un peu du côté de l’extrême-droite. L’autre jour, j’ai vu un film de Steve Olson avec Logan Price, Finn Bowman et Savannah Ramirez. Dans un futur proche, à Brooklyn, des vampires nazis s’attaquent aux Juifs pour les vider de leur sang une bonne fois pour toutes. Sauf que les Juifs ultra-orthodoxes Borough Park ont retenu la leçon de 45 et ne sont pas du genre à se laisser génocider sans réagir. Or, aux États-Unis, terre promise de la liberté de vendre chèrement sa peau au plus offrant, il se trouve que le lance-flammes est en vente libre, comme d’ailleurs à peu près tout ce qui peut servir à se débarrasser efficacement de son prochain, à part les armes chimiques et les mines antipersonnel, en principe réservées à un usage strictement militaire. Même Elon Musk\nf{Elon Musk (né en 1971), entrepreneur sud-africano-américain, fondateur de SpaceX, Tesla et co-fondateur de PayPal. En 2018, sa société The Boring Company a commercialisé environ 20~000~unités d’un lance-flammes surnommé «~Not a Flamethrower~» à 500~dollars pièce. \source{fr.wikipedia.org/wiki/Elon\_Musk}}, en son temps, vendait des lance-flammes pour le compte de la Boring Company\nf{The Boring Company, fondée en 2016 par Elon Musk, est une entreprise américaine de construction de tunnels et de transport souterrain. En 2018, elle a commercialisé environ 20~000 unités d’un lance-flammes baptisé «~Not a Flamethrower~» à 500~dollars pièce, à des fins de communication autant que de profit. \source{fr.wikipedia.org/wiki/The\_Boring\_Company}}, sa société de construction de tunnels. Il s’agissait plus de briquets géants que de véritables armes de guerre, mais tout de même on {\iconographieinlineblock[t]{\bwimage[width=0.9\textwidth]{acte_04/scene_6/_0370_the-boring-company.png}}{}} était assez proche de l’esprit néo-nazi high-tech dont il semble aujourd’hui se revendiquer, sachant qu’il ferait un SS tout à fait convaincant avec un uniforme sur le dos. Je me souviens qu’à l’époque, la rumeur circulait qu’il préparait une attaque massive de zombies pour booster les ventes de son gadget crématoire. Donc, les Juifs ultra-orthodoxes de Brooklyn se précipitent dans les armureries et font une razzia sur les lance-flammes, la seule arme véritablement efficace pour renvoyer les vampires en enfer. La plupart des vampires sont détruits, mais leur chef, l’ignoble Frozzan, alias le Porteur de la Mort, échappe au carnage et tombe amoureux de la belle Rachel, une jeune juive sublime aux yeux verts qui est le portrait craché de sa femme, la somptueuse Katharina, morte dans des circonstances on ne peut plus dramatiques. Nazi de la première heure et membre de la garde rapprochée du Führer, Frozzan, de son vrai nom Armin Böhmer, assiste en direct à la mort du dictateur sanguinaire, antisémite, raciste et homophobe, et sort très éprouvé de cette terrible épreuve. Il se débarrasse ensuite de son uniforme, enfile des vêtements civils empruntés à Hitler qui n’en a plus besoin et fait sensiblement la même taille que lui, et fonce retrouver sa femme dans leur appartement de la Friedrichstrasse\nf{Artère nord-sud du centre de Berlin (quartier de Mitte), connue pour son boulevard commercial et sa gare (\textit{Bahnhof Friedrichstraße}). Pendant la Guerre froide, le poste-frontière «~Checkpoint Charlie~» en faisait l’un des points de passage les plus surveillés entre Berlin-Ouest et Berlin-Est.\source{fr.wikipedia.org/wiki/Friedrichstraße}}, se frayant tant bien que mal un passage au milieu des cadavres et des gravats. {\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_04/scene_6/_0380_friedrichstrasse-1945.jpg}}{Berlin Friedrichstrasse \textup{1945}}} Mais quand il arrive, il trouve la porte défoncée et l’appartement dévasté. Le corps de Katharina, entièrement dénudé et couvert de contusions horribles, repose au milieu du salon, sans vie. Il ne fait aucun doute qu’elle a été sauvagement violée et assassinée par les soudards de l’Armée rouge\nf{Lors de la prise de Berlin (avril--mai 1945), les soldats de l’Armée rouge commirent des dizaines de milliers de viols sur la population civile allemande, phénomène longtemps occulté par l’historiographie soviétique. Les estimations varient entre 100\,000 et 400\,000 victimes pour la seule ville de Berlin.\source{fr.wikipedia.org/wiki/Viols\_lors\_de\_la\_prise\_de\_Berlin}}, horde barbare dont on connaît la violence extrême et l’absence totale de moralité. Fou de rage et de douleur, Böhmer renie Dieu, allant même jusqu’à uriner sur un crucifix jeté au sol dans la tourmente, et jure de revenir d’entre les morts pour se venger et poursuivre l’œuvre du Führer.
...
\textsc{Moi} : À ne surtout pas confondre avec \textit{Un vampire à Brooklyn}\nf{\textit{Un vampire à Brooklyn} (\textit{Vampire in Brooklyn}, 1995), film d’horreur-comédie réalisé par Wes Craven, avec Eddie Murphy dans le rôle d’un vampire caribéen qui débarque à Brooklyn pour retrouver une descendante pouvant perpétuer sa lignée. \source{fr.wikipedia.org/wiki/Un\_vampire\_à\_Brooklyn}} de Wes Craven\nf{Wes Craven (1939--2015), réalisateur américain, figure majeure du cinéma d’horreur. Il est notamment l’auteur des sagas \textit{Les Griffes de la nuit} (1984), \textit{Scream} (1996) et du film \textit{La Colline a des yeux} (1977). \source{fr.wikipedia.org/wiki/Wes\_Craven}}, avec Eddie Murphy\nf{Eddie Murphy (né en 1961), acteur et comédien américain, révélé par le \textit{Saturday Night Live} et les films \textit{48 heures} (1982) et \textit{Le Flic de Beverly Hills} (1984). \source{fr.wikipedia.org/wiki/Eddie\_Murphy}} dans le rôle d’un vampire caribéen qui débarque à Brooklyn pour assurer sa descendance. Mais je suppose que tu n’as jamais entendu parler de Wes Craven.

\textsc{Lui} : Bingo !

\textsc{Moi} : Ni de \textit{Beverly Hills Vamp}\nf{\textit{Beverly Hills Vamp} (1989), film d’horreur-comédie américain de Fred Olen Ray. Trois jeunes cinéastes débarquent à Hollywood et tombent sur un bordel tenu par des vampires. Série B de série Z. \source{fr.wikipedia.org/wiki/Beverly\_Hills\_Vamp}}, un navet qui met aux prises trois crétins patentés avec des putes vampires dans un bordel de la ville.

\illusloflabel{\textit{Un vampire à Brooklyn}}%
\illusloflabel{\textit{Beverly Hills Vamp}}%
\iconographiedouble[b][5.5cm][0.8cm]{acte_04/scene_6/_0400_un-vampire-à-brooklyn.jpg}{acte_04/scene_6/_0430_beverly-hills-vamp.jpg}[Un vampire à Brooklyn \textup{1995} · Beverly Hills Vamp \textup{1989}]%
...
Sally Robinson n’était pas à proprement parler ce qu’il est convenu d’appeler une belle femme, au grand dam de Greg qui s’attendait à voir débarquer Rhonda Fleming\nf{Rhonda Fleming (1923--2020), actrice américaine surnommée «~la Reine du Technicolor~» pour sa chevelure rousse flamboyante. Figure du film noir et du western des années 1940--1950, notamment dans \textit{Spellbound} (1945) d’Alfred Hitchcock. \source{fr.wikipedia.org/wiki/Rhonda\_Fleming}}, Lana Turner\nf{Lana Turner (1921--1995), actrice américaine, icône hollywoodienne des années 1940--1950. Elle tint le premier rôle féminin de \textit{The Postman Always Rings Twice} (1946). Sa vie privée tumultueuse — sept mariages et l’assassinat de son amant par sa fille — alimenta la chronique. \source{fr.wikipedia.org/wiki/Lana\_Turner}}, Gene Tierney\nf{Gene Tierney (1920--1991), actrice américaine, célèbre pour son rôle-titre dans \textit{Laura} (1944) de Otto Preminger et pour \textit{Leave Her to Heaven} (1945). Considérée comme l’une des plus belles actrices de l’âge d’or d’Hollywood. \source{fr.wikipedia.org/wiki/Gene\_Tierney}}, Lauren Bacall\nf{Lauren Bacall (1924--2014), actrice américaine, figure du film noir et du glamour hollywoodien. Révélée par \textit{To Have and Have Not} (1944) aux côtés d’Humphrey Bogart, qu’elle épousa. Connue pour sa voix grave et son regard magnétique. \source{fr.wikipedia.org/wiki/Lauren\_Bacall}} ou Sharon Stone\nf{Sharon Stone (née en 1958), actrice américaine, révélée par \textit{Basic Instinct} (1992) de Paul Verhoeven. Nommée aux Oscars pour \textit{Casino} (1995) de Martin Scorsese. \source{fr.wikipedia.org/wiki/Sharon\_Stone}}.

\iconographietex{figures/women_fig.tex}

Ne vous en déplaise, Sally Robinson n’avait rien de commun avec ces femmes fatales qui ondulent dans les romans de Chandler\nf{Raymond Chandler (1888--1959), romancier américain, créateur du détective Philip Marlowe. Auteur de \textit{Le Grand Sommeil} (1939) et \textit{La Dame du lac} (1943), il est avec Dashiell Hammett le fondateur du roman noir américain (\textit{hard-boiled}). \source{fr.wikipedia.org/wiki/Raymond\_Chandler}}, Hammett\nf{Dashiell Hammett (1894--1961), romancier américain, créateur du détective Sam Spade (\textit{Le Faucon maltais}, 1930) et de Nick Charles. Ancien détective de l’agence Pinkerton, il inventa le roman noir réaliste. \source{fr.wikipedia.org/wiki/Dashiell\_Hammett}}, Goodis\nf{David Goodis (1917--1967), romancier américain du roman noir, auteur notamment de \textit{Tirez sur le pianiste} (1956, adapté par Truffaut en 1960) et \textit{La Lune dans le caniveau} (1953, adapté par Beineix en 1983). Ses héros sont des losers magnifiques et désespérés. \source{fr.wikipedia.org/wiki/David\_Goodis}} et les autres, chantent comme des sirènes et entraînent les marins d’eau douce dans les profondeurs glacées du désespoir et la décrépitude la plus totale, tant physique que morale. Si tous les gens qui croisaient le chemin de Sally Robinson avaient envie de l’éradiquer, à commencer par les femmes dont elle dégradait sérieusement l’image, c’est parce que la société se présente sous la forme d’un organisme savamment structuré et se comporte comme tel, à savoir qu’il cherche à éliminer ou expulser tout corps étranger dont il détecte la présence en son sein, expurger sans ménagement de la surface de son épiderme satiné toute excroissance disgracieuse ou furoncle gorgé de pus. Et je vous prie de croire que la présence de Sally Robinson avait été détectée, depuis longtemps, et que tous les anticorps disponibles avaient été mobilisés pour tenter de venir à bout d’un des agents pathogènes les plus redoutables de toute l’histoire de l’humanité, au moins sur le plan de l’esthétique et du bon goût, de la joie de vivre et la culture générale.
...
\illusloflabel{We're so sorry, but the image…}%
Oui, eh bien si vous pensez vraiment que je pousse le bouchon un peu loin, je vous suggère de procéder à l’expérience suivante : essayez \iconographiewrapfig{r}{0.6\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0100_vito-mickey-anderson.jpg}}{}d’imaginer Danny DeVito\nf{Danny DeVito (né en 1944), acteur et réalisateur américain, connu pour ses rôles dans \textit{One Flew Over the Cuckoo’s Nest} (1975), la série \textit{Taxi} (1978--1983) et \textit{Batman Returns} (1992) dans lequel il incarne le Pingouin. Sa petite taille (1,47~m) et sa personnalité exubérante en font un acteur immédiatement reconnaissable. \source{fr.wikipedia.org/wiki/Danny\_DeVito}} avec des oreilles de Mickey\nf{Mickey Mouse, personnage de dessin animé créé par Walt Disney et Ub Iwerks en 1928 (\textit{Steamboat Willie}), première animation sonore synchronisée. Mascotte officielle de The Walt Disney Company, reconnaissable entre tous à ses grandes oreilles rondes noires. \source{fr.wikipedia.org/wiki/Mickey\_Mouse}} et les nichons de Pamela Anderson\nf{Pamela Anderson (née en 1967), actrice et mannequin canadienne, révélée par la série \textit{Alerte à Malibu} (1992--1997). Symbole de la blonde glamour des années 1990, elle fut l’une des personnalités les plus photographiées au monde. \source{fr.wikipedia.org/wiki/Pamela\_Anderson}}.
...
Il s’est dit : pas de panique, mon garçon, on est au \textsc{xxi}\textsuperscript{e}~siècle ! Ce n’est pas le siècle des lumières, plutôt celui de l’extinction des feux, mais un vrai professionnel se doit de garder la tête froide en toute circonstance.
...
\illusloflabel{Cycliste en pleine ascension du col du Galibier}%
\iconographiewrapfig{l}{0.225\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0130_galibier.jpg}}{}%
%
\textsc{Sally}, prenant place dans le fauteuil en tortillant du cul tel un cycliste en pleine ascension du col du Galibier\nf{Col alpin (alt.~2642~m) dans les Hautes-Alpes, entre Saint-Michel-de-Maurienne et Briançon. Étape mythique du Tour de France depuis 1911, il offre un panorama sur la Meije et les massifs des Écrins.\source{fr.wikipedia.org/wiki/Col\_du\_Galibier}} : Je vous remercie.
...
\illusloflabel{Jack Daniel’s}%
\iconographiewrapfig{r}{0.15\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0140_jack-daniel_s.jpg}}{}%
%
Greg s’est levé, dirigé vers le bar, est revenu avec une bouteille de Jack Daniel’s\nf{Jack Daniel’s, whisky tennesseen produit à Lynchburg (Tennessee, États-Unis) depuis 1866, l’une des marques de whisky les plus vendues au monde. \source{fr.wikipedia.org/wiki/Jack\_Daniel's}} et de deux verres : Je n’ai que ça. J’espère que ça fera l’affaire.
...
\illusloflabel{Direction générale de la Sécurité extérieure}%
\iconographiewrapfig{r}{0.33\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0150_dgse.png}}{}%
%
\textsc{Greg} : Oui, ce n’est pas comme si il travaillait à la DGSE\nf{Direction générale de la Sécurité extérieure, le service de renseignement extérieur français, placé sous l'autorité du Premier ministre. \source{fr.wikipedia.org/wiki/Direction\_générale\_de\_la\_Sécurité\_extérieure}}. Des problèmes de drogue, alcool ou autre ?
...
\illusloflabel{Kitten Natividad}%
\iconographiewrapfig{r}{0.55\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0270_kitten_natividad.jpg}}{ Kitten Natividad \\[-3pt] \textup{1948--2022}}%
%
Russ Meyer\nf{Russ Meyer (1922--2004), réalisateur américain, pionnier du film érotique indépendant dit «~sexploitation~». Auteur de \textit{Faster, Pussycat! Kill! Kill!} (1965) et d’une œuvre caractérisée par l’humour burlesque et la mise en scène de femmes à la poitrine opulente. \source{fr.wikipedia.org/wiki/Russ\_Meyer}}, le roi de la sexploitation (avec Tinto Brass\nf{Tinto Brass (né en 1933), réalisateur et monteur italien, connu pour des films érotiques provocateurs dont \textit{Caligula} (1979) et \textit{Salon Kitty} (1976). \source{fr.wikipedia.org/wiki/Tinto\_Brass}} et Jess Franco\nf{Jess Franco (1930--2013), réalisateur espagnol prolifique, auteur de plus de deux cents films d’exploitation mêlant horreur et érotisme. Figure culte du cinéma de genre européen des années 1960--1980. \source{fr.wikipedia.org/wiki/Jess\_Franco}}), ennemi juré de la morale judéo-chrétienne et du code Hays\nf{Le code Hays, ou Code de production, est un ensemble de règles de censure morale imposées à Hollywood de 1934 à 1968. Il interdisait notamment la nudité, les relations sexuelles explicites et toute représentation jugée contraire aux bonnes mœurs. \source{fr.wikipedia.org/wiki/Code\_Hays}}, à qui l’on doit une foultitude de chefs-d’œuvre presque tous aussi inoubliables les uns que les autres, parmi lesquels \textit{Le Désir dans les tripes}\nf{Titre français de \textit{Mudhoney} (1965), film de Russ Meyer (1922--2004), réalisateur américain spécialisé dans le cinéma d’exploitation érotique et burlesque. Quentin Tarantino le revendique parmi ses influences.\source{en.wikipedia.org/wiki/Mudhoney\_(film)}}, \textit{Mondo Topless}\nf{Film de Russ Meyer (1966), documentaire fictionnel composé de séquences de danses topless dans les cabarets américains. Premier film du réalisateur à rapporter plus d’un million de dollars, il lui permit de financer ses projets suivants.\source{en.wikipedia.org/wiki/Mondo\_Topless}}, \textit{La Vallée des Plaisirs}\nf{Titre attribué à \textit{The Immoral Mr.~Teas} (1959), premier long métrage de Russ Meyer et premier film «~nudie cutie~» de l’histoire du cinéma américain à rapporter plus d’un million de dollars au box-office.\source{en.wikipedia.org/wiki/The\_Immoral\_Mr.\_Teas}} et la série des Vixens\nf{Trilogie érotique de Russ Meyer : \textit{Vixen!} (1968), \textit{Supervixens} (1975) et \textit{Beneath the Valley of the Ultra-Vixens} (1979), célèbre pour ses personnages féminins exubérants et ses satires de la société américaine.\source{fr.wikipedia.org/wiki/Vixen\_(film)}}. Spéciale dédicace à Kitten Natividad\nf{Kitten Natividad (1948--2022), actrice américaine d’origine mexicaine, muse de Russ Meyer. Connue pour ses rôles dans \textit{Up!} (1976) et \textit{Beneath the Valley of the Ultra-Vixens} (1979). Icône de la sexploitation des années 1970. \source{fr.wikipedia.org/wiki/Kitten\_Natividad}}, alias Lola Langusta. 
...
\illusloflabel{Will H. Hays et des dirigeants de studio hollywoodiens}%
\iconographiewrapfig{l}{0.48\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0220_code-hays.jpg}}{Will H. Hays et des dirigeants de studio hollywoodiens,\textup{1938}}%
%
...
Une petite musique s’est fait entendre dans le fond de mon crâne, une petite musique genre flûte de pan dans la pampa, comme dans \textit{Mission} de Joffé\nf{Roland Joffé (né en 1945), réalisateur britannique, auteur de \textit{Mission} (1986), film sur les missions jésuites guaranis en Amérique du Sud au \textsc{xviii}\textsuperscript{e}~siècle, Palme d’or à Cannes. La bande originale, signée Ennio Morricone, inclut le célèbre \textit{Gabriel’s Oboe}. \source{fr.wikipedia.org/wiki/Mission\_(film,\_1986)}} ou \textit{Apocalypto} de Mel Gibson\nf{Mel Gibson (né en 1956), acteur et réalisateur américano-australien. Récompensé de l’Oscar du meilleur film pour \textit{Braveheart} (1995), il réalise également \textit{La Passion du Christ} (2004) et \textit{Apocalypto} (2006). Ses déclarations antisémites (2006) et ses soutiens politiques controversés ont alimenté les polémiques. \source{fr.wikipedia.org/wiki/Mel\_Gibson}}, ce crétin réactionnaire qui vote Trump au même titre que Kanye West\nf{Kanye West (né en 1977), rappeur, producteur et entrepreneur américain, auteur de \textit{The College Dropout} (2004) et \textit{My Beautiful Dark Twisted Fantasy} (2010). Connu pour ses prises de position erratiques, ses déclarations antisémites (2022) et son soutien affiché à Donald Trump. \source{fr.wikipedia.org/wiki/Kanye\_West}}, Jon Voight\nf{Jon Voight (né en 1938), acteur américain, Oscar du meilleur acteur pour \textit{Le Retour} (1978) et père d’Angelina Jolie. Républicain militant, il soutient Donald Trump depuis 2016. \source{fr.wikipedia.org/wiki/Jon\_Voight}}, Dana White\nf{Dana White (né en 1969), homme d’affaires américain, président de l’Ultimate Fighting Championship (UFC) depuis 2001. Il a transformé l’UFC en une organisation mondiale de MMA pesant plusieurs milliards de dollars. Soutien affiché et proche de Donald Trump. \source{fr.wikipedia.org/wiki/Dana\_White}} et Buzz Aldrin\nf{Buzz Aldrin (né en 1930), astronaute et pilote militaire américain. Le 21~juillet 1969, il est le deuxième homme à marcher sur la Lune lors de la mission \textit{Apollo~11}, après Neil Armstrong. \source{fr.wikipedia.org/wiki/Buzz\_Aldrin}}, calviniste de mes deux qui aurait mieux fait de rester sur la Lune le jour où il y a posé le pied, le 21 juillet 1969. Make America Beauf Again\nf{Parodie du slogan «~Make America Great Again~» (MAGA), adopté par Donald Trump pour ses campagnes de 2016 et 2024. Le terme «~beauf~» (contraction de «~beau-frère~»), popularisé par Cabu dans \textit{Le Chaland qui passe} (1973), désigne le Français moyen lourdaud, raciste et macho.\source{fr.wikipedia.org/wiki/Make\_America\_Great\_Again}}, les rednecks\nf{Terme péjoratif américain désignant les ruraux blancs pauvres et conservateurs, originellement les agriculteurs du Sud dont la nuque brûlait au soleil. Dans la culture populaire, synonyme de sectarisme, d’ignorance et de patriotisme exacerbé.\source{fr.wikipedia.org/wiki/Redneck}} ont encore de beaux jours devant eux.
...
\illusloflabel{}
\iconographiewrapfig{r}{0.333\textwidth}{\bwimage[width=\linewidth]{acte_04/scene_7/_0360_ouroboros.png}}{Anneau de peircing Ouroboros}%
%
\textsc{Moi} : En forme de serpent qui se mord la queue\nf{L'ouroboros, symbole ancien représentant un serpent (ou dragon) se mordant la queue, évoque le cycle éternel, l'infini et l'auto-régénération. Présent dans les traditions égyptienne, grecque, alchimique et gnostique. \source{fr.wikipedia.org/wiki/Ouroboros}} ?

\textsc{Lui} : Tout juste, Auguste.

\textsc{Moi} : On les a retrouvés au milieu des cendres. Je suppose qu’il y a des tas gens qui ont des piercings de ce genre, mais il y a quand même de fortes chances pour ton client et le mien soient une seule et même personne. D’autant que si on en croit Zaahid, qui se trompe rarement sur le sujet, le mien descend en droite ligne des Nambikwara, une tribu amérindienne du Mato Grosso dont seuls quelques rares spécimens s’accrochent encore aux branches de la forêt amazonienne. Je pense que ça commence à faire beaucoup, tu ne crois pas.
...
\illusloflabel{Coucher de soleil sur l'Arno à Florence}%
Petite mise au point en passant : c’est au Narcisse Rose que j’avais, quelque temps plus tôt, fait la connaissance de Zarina Brizzi, trente-deux ans et toutes ses dents, archétype du missile supersonique made in Italy (comme le missile balistique Alfa\nf{L’\textit{Alfa} est un missile balistique à propergol solide développé dans les années 1970 par la société italienne OTO Melara (aujourd’hui Leonardo) pour équiper les sous-marins de la Marine italienne. Il ne fut jamais déployé opérationnellement, notamment en raison des contraintes du Traité sur la non-prolifération des armes nucléaires. \source{fr.wikipedia.org/wiki/Alfa\_(missile)}} au propergol solide développé par Leonardo\nf{Leonardo S.p.A., anciennement Finmeccanica, est un conglomérat industriel italien de défense et d’aérospatiale fondé en 1948. Il est notamment actif dans les secteurs des hélicoptères, de l’électronique de défense et des missiles. \source{fr.wikipedia.org/wiki/Leonardo\_(entreprise)}} dans les années 70, soi-disant resté à quai après l’adoption du traité rédigé par l’ONU dans le but de contrôler et limiter au maximum la prolifération des armes nucléaires à travers le monde\nf{Le Traité sur la non-prolifération des armes nucléaires (TNP), ouvert à la signature en 1968 et entré en vigueur en 1970, vise à prévenir la dissémination des armes nucléaires, à promouvoir le désarmement et à favoriser l'usage pacifique de l'énergie nucléaire. Il compte 191 États parties. \source{fr.wikipedia.org/wiki/Traité\_sur\_la\_non-prolifération\_des\_armes\_nucléaires}}), aussi bouleversante qu’une assiette de pappardelle au sanglier ou de lapin au chou et raisins secs, longue chevelure brune ramassée en un savant entrelacs (ne me demandez pas pourquoi il y a un S à la fin, ça fait partie du charme de la langue française, comme contrebasse, architecture, daim, ornithorynque, Seldjoukides, groupe sanguin, orang-outan et Vincent van Gogh pour n’en citer que quelques-uns\nf{\textit{The Unanswered Question} est une pièce pour orchestre de chambre du compositeur américain Charles Ives, écrite vers 1908 et publiée en 1953. Elle est considérée comme l’une des œuvres les plus emblématiques de la musique américaine du \textsc{xx}\textsuperscript{e} siècle. \source{fr.wikipedia.org/wiki/The\_Unanswered\_Question}}) de mèches tressées avec une maestria confondante, regard profond comme les eaux de l’Arno\nf{L’Arno (240~km) est le fleuve traversant Florence de part en part, passant sous le Ponte Vecchio et se jetant dans la mer Tyrrhénienne à Pise. Il détermine la géographie et l’histoire de la ville depuis l’Antiquité.\source{fr.wikipedia.org/wiki/Arno\_(fleuve)}} \iconographieimg[1]{acte_04/scene_7/_0410_tramonto-firenze.jpg}{Coucher de soleil sur l'Arno à Florence} quand le soleil se couche sur Florence et que vous êtes en train de vous goinfrer de crostini neri aux foie de volaille, câpres et anchois dans une antique trattoria de la via della Scala, etc., etc. … et tout cela, oui tout cela est très émotionnant, c’est certain, et je pourrais continuer pendant des centaines et des centaines de milliers de pages à vous décrire au millimètre près le moindre centimètre-carré de son incomparable épiderme à la coloration parfaite, mais l’essentiel de ce que vous avez à savoir tient en quelques mots : oui, elle et moi formions maintenant ce qu’il est convenu d’appeler un couple, et j’avais, à mon grand regret, dû renoncer au vœu de chasteté qui m’avait jusqu’alors tenu éloigné de la promiscuité charnelle inhérente à ce genre d’activité. Autrement dit il nous arrivait, Zarina et moi, de niquer comme des bêtes jusque tard dans la nuit. Et vous devez savoir aussi, par la même occasion, que Zarina avait une sœur, Tosca, copie conforme d’elle-même à quelques détails près, et que cette même sœur formait avec mon ami Zaahid Shirani ce qu’il est également convenu d’appeler un couple, autrement qu’il arrivait aussi à Zaahid et Tosca de niquer jusque tard dans la nuit, et je dirais même, les concernant, que cette activité avait pris une place prépondérante dans leur existence. J’ajoute que toutes deux avaient rendu les clés de leur suite du Jade Mountain Hôtel pour venir s’installer chez l’un et l’autre de leurs conjoints respectifs, ce qui ne m’arrangeait qu’à moitié dans la mesure où j’avais pris des habitudes de vieux garçon auxquelles je n’entendais pas renoncer aussi facilement.
