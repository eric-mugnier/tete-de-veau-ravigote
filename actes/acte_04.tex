...
Assez loin de ces considérations, tous les dimanches matin, aux premières lueurs de l’aube, Robert Pleimelding allait à la chasse. Avec sa fidèle Greta, un braque allemand à poil dur qu’il appelait «~ma fille~» ou \iconographiewrapfig{l}{0.66\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_5/_0000_braque-allemand-a-poil-dur.jpg}}{Braque allemand à poil dur} «~fifille~», alors même qu’il avait déjà une fille, une vraie, avec laquelle il n’échangeait guère plus de trois ou quatre mots par an, et encore seulement les bonnes années.
...
Hélas, ou tant mieux, tout a une fin, à commencer par les meilleures \iconographiewrapfig{r}{0.08\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_5/_0040_cohiba.png}}{~} choses dont la durée de vie est d’autant plus courte qu’elles se rapprochent de l’excellence.
...
\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_04/chapter_5/_0060_chapuis-progress_2.jpg}}{Chapuis Progress Série 3 Grand Luxe impérial}
...
\begin{center}
\lilypondfile[line-width=\linewidth,staffsize=12]{music/galop-infernal.ly}
\end{center}
\begin{center}
  \vspace{-1\onelineskip}
  {\centering\scriptsize{Jacques Offenbach · Orphée aux enfers · Galop infernal }}
...
\iconographieinlineblock[t]{\bwimage[width=0.9\textwidth]{acte_04/chapter_5/_0130_noahs-ark-edward-hicks.png}}{Edward Hicks · L'Arche de Noé · 1846}
...
\iconographiewrapfig{l}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_5/_0270_le-vieux-fusil.jpg}}{Le Vieux Fusil} 
...
\iconographieinlineblock[]{\bwimage[width=\textwidth]{acte_04/chapter_5/_0290_romy-schneider.jpg}}{Romy Schneider}
...
\iconographiedouble[b][6cm]{acte_04/chapter_5/_0400_un-vampire-à-brooklyn.jpg}{acte_04/chapter_5/_0430_beverly-hills-vamp.jpg}
...
Sally Robinson n’était pas à proprement parler ce qu’il est convenu d’appeler une belle femme, au grand dam de Greg qui s’attendait à voir débarquer Rhonda Fleming\nf{Rhonda Fleming (1923--2020), actrice américaine surnommée «~la Reine du Technicolor~» pour sa chevelure rousse flamboyante. Figure du film noir et du western des années 1940--1950, notamment dans \textit{Spellbound} (1945) d’Alfred Hitchcock. \source{en.wikipedia.org/wiki/Rhonda\_Fleming}}, Lana Turner\nf{Lana Turner (1921--1995), actrice américaine, icône hollywoodienne des années 1940--1950. Elle tint le premier rôle féminin de \textit{The Postman Always Rings Twice} (1946). Sa vie privée tumultueuse — sept mariages et l’assassinat de son amant par sa fille — alimenta la chronique. \source{en.wikipedia.org/wiki/Lana\_Turner}}, Gene Tierney\nf{Gene Tierney (1920--1991), actrice américaine, célèbre pour son rôle-titre dans \textit{Laura} (1944) de Otto Preminger et pour \textit{Leave Her to Heaven} (1945). Considérée comme l’une des plus belles actrices de l’âge d’or d’Hollywood. \source{en.wikipedia.org/wiki/Gene\_Tierney}}, Lauren Bacall\nf{Lauren Bacall (1924--2014), actrice américaine, figure du film noir et du glamour hollywoodien. Révélée par \textit{To Have and Have Not} (1944) aux côtés d’Humphrey Bogart, qu’elle épousa. Connue pour sa voix grave et son regard magnétique. \source{en.wikipedia.org/wiki/Lauren\_Bacall}} ou Sharon Stone\nf{Sharon Stone (née en 1958), actrice américaine, révélée par \textit{Basic Instinct} (1992) de Paul Verhoeven. Nommée aux Oscars pour \textit{Casino} (1995) de Martin Scorsese. \source{en.wikipedia.org/wiki/Sharon\_Stone}}.

\iconographietex{figures/women_fig.tex}

Ne vous en déplaise, Sally Robinson n’avait rien de commun avec ces femmes fatales qui ondulent dans les romans de Chandler\nf{Raymond Chandler (1888--1959), romancier américain, créateur du détective Philip Marlowe. Auteur de \textit{Le Grand Sommeil} (1939) et \textit{La Dame du lac} (1943), il est avec Dashiell Hammett le fondateur du roman noir américain (\textit{hard-boiled}). \source{en.wikipedia.org/wiki/Raymond\_Chandler}}, Hammett\nf{Dashiell Hammett (1894--1961), romancier américain, créateur du détective Sam Spade (\textit{Le Faucon maltais}, 1930) et de Nick Charles. Ancien détective de l’agence Pinkerton, il inventa le roman noir réaliste. \source{en.wikipedia.org/wiki/Dashiell\_Hammett}}, Goodis\nf{David Goodis (1917--1967), romancier américain du roman noir, auteur notamment de \textit{Tirez sur le pianiste} (1956, adapté par Truffaut en 1960) et \textit{La Lune dans le caniveau} (1953, adapté par Beineix en 1983). Ses héros sont des losers magnifiques et désespérés. \source{en.wikipedia.org/wiki/David\_Goodis}} et les autres, chantent comme des sirènes et entraînent les marins d’eau douce dans les profondeurs glacées du désespoir et la décrépitude la plus totale, tant physique que morale. Si tous les gens qui croisaient le chemin de Sally Robinson avaient envie de l’éradiquer, à commencer par les femmes dont elle dégradait sérieusement l’image, c’est parce que la société se présente sous la forme d’un organisme savamment structuré et se comporte comme tel, à savoir qu’il cherche à éliminer ou expulser tout corps étranger dont il détecte la présence en son sein, expurger sans ménagement de la surface de son épiderme satiné toute excroissance disgracieuse ou furoncle gorgé de pus. Et je vous prie de croire que la présence de Sally Robinson avait été détectée, depuis longtemps, et que tous les anticorps disponibles avaient été mobilisés pour tenter de venir à bout d’un des agents pathogènes les plus redoutables de toute l’histoire de l’humanité, au moins sur le plan de l’esthétique et du bon goût, de la joie de vivre et la culture générale.
...
Oui, eh bien si vous pensez vraiment que je pousse le bouchon un peu loin, je vous suggère de procéder à l’expérience suivante : essayez \iconographiewrapfig{r}{0.6\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_6/_0100_vito-mickey-anderson.jpg}}{} d’imaginer Danny DeVito\nf{Danny DeVito (né en 1944), acteur et réalisateur américain, connu pour ses rôles dans \textit{One Flew Over the Cuckoo’s Nest} (1975), la série \textit{Taxi} (1978--1983) et \textit{Batman Returns} (1992) dans lequel il incarne le Pingouin. Sa petite taille (1,47~m) et sa personnalité exubérante en font un acteur immédiatement reconnaissable. \source{en.wikipedia.org/wiki/Danny\_DeVito}} avec des oreilles de Mickey\nf{Mickey Mouse, personnage de dessin animé créé par Walt Disney et Ub Iwerks en 1928 (\textit{Steamboat Willie}), première animation sonore synchronisée. Mascotte officielle de The Walt Disney Company, reconnaissable entre tous à ses grandes oreilles rondes noires. \source{en.wikipedia.org/wiki/Mickey\_Mouse}} et les nichons de Pamela Anderson\nf{Pamela Anderson (née en 1967), actrice et mannequin canadienne, révélée par la série \textit{Alerte à Malibu} (1992--1997). Symbole de la blonde glamour des années 1990, elle fut l’une des personnalités les plus photographiées au monde. \source{en.wikipedia.org/wiki/Pamela\_Anderson}}.
...
\iconographiewrapfig{l}{0.25\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_6/_0130_galibier.jpg}}{}
...
\iconographiewrapfig{r}{0.18\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_6/_0140_jack-daniel_s.jpg}}{}
Greg s’est levé, dirigé vers le bar, est revenu avec une bouteille de Jack Daniel’s\nf{Jack Daniel’s, whisky tennesseen produit à Lynchburg (Tennessee, États-Unis) depuis 1866, l’une des marques de whisky les plus vendues au monde. \source{fr.wikipedia.org/wiki/Jack\_Daniel\%27s}} et de deux verres : Je n’ai que ça. J’espère que ça fera l’affaire.
...
\iconographiewrapfig{r}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_6/_0150_dgse.png}}{}
\textsc{Greg} : Oui, ce n’est pas comme si il travaillait à la DGSE\nf{Direction générale de la Sécurité extérieure, le service de renseignement extérieur français, placé sous l'autorité du Premier ministre. \source{fr.wikipedia.org/wiki/Direction\_g\%C3\%A9n\%C3\%A9rale\_de\_la\_S\%C3\%A9curit\%C3\%A9\_ext\%C3\%A9rieure}}. Des problèmes de drogue, alcool ou autre ?
...
\textsc{Moi} : On n’arrête pas le progrès. Si demain des gens ont envie de se faire greffer un troisième sein, une langue de serpent ou un deuxième trou de balle, il y aura toujours quelqu’un pour leur donner satisfaction. Ça leur coûtera la peau des fesses, mais ils pourront toujours, moyennant une \iconographiewrapfig{r}{0.45\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_7/_0070_code-hays.jpg}}{Will H. Hays, with Hollywood studios executives, 1938} petite rallonge, se la faire remplacer par du cuir d’hippopotame, nettement plus résistant quand on passe sa vie assis devant un ordinateur ou une console de jeu.
...
\iconographiewrapfig{r}{0.3\textwidth}{\bwimage[width=\linewidth]{acte_04/chapter_7/_0210_ouroboros.png}}{Anneau de peircing Ouroboros}
