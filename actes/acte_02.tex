...
\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_02/_0010_bengale.jpg}}{La partition des Indes de 1947}
...
\iconographieinlineblock[]{\bwimage[width=\textwidth]{acte_02/_0015_hemingway-short-story.png}}{} %% \centering\scriptsize\itshape {Hemingway Short Story}
...
%% \iconographiewrapfig{r}{0.25\textwidth}{\bwimage[width=\linewidth]{acte_02/_0020_marthe-richard.jpg}}{Marthe Richard}
...
\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_02/_0030_gange.jpg}}{Inde: l'eau du Gange pourrait être cancérigène}
...
\lilypondfile[line-width=\linewidth,staffsize=12]{music/shostakovich8_cleaned.ly}
\begin{center}
  \vspace{-0.8\onelineskip}
  {\centering\scriptsize{Дмитрий Шостакович · Симфония №\,8 · I часть · \emph{Adagio}}}
  \vspace{0.2\onelineskip}
\end{center}
\end{minipage}
\fi
...
\iconographiewrapfig{l}{0.6\textwidth}{\bwimage[width=\linewidth]{acte_02/_0110_jack-l-eventreur.jpg}}{Découverte d'une victime de Jack l'Éventreur}\textsc{Lui} : Donc, si je comprends bien, le tueur a des notions de médecine et les moyens de ses ambitions. Pourquoi pas un chirurgien ?
...
\iconographieinlineblock[b]{\bwimage[width=\textwidth]{acte_02/_musk-trump-poutine-bolsonaro-meloni.jpg}}{}
...
Le soir même, après une journée de boulot bien remplie comme vous avez pu le constater, je rentrais tranquillement chez moi, avec la satisfaction du devoir accompli, quand je me suis rendu compte que quelque chose clochait dans le périmètre. Dans le rétro de ma Kangoo,  \iconographiewrapfig{l}{0.5\textwidth}{\bwimage[width=\linewidth]{acte_02/_0175_alfa-romeo-giulietta-noir-alfa-black.png}}{Alfa Romeo Giulietta}plus exactement. Sauf à être devenu complètement parano, ce qui n’était pas impossible vu les cadences infernales auxquelles nous étions soumis, une voiture me suivait. Une Alfa Romeo Giulietta noire aux vitres teintées, le genre de caisse pilotée neuf fois sur dix par une tête à claques qui se prend pour Fangio et finit encastré dans le premier platane qui passe à sa portée. Nous, les vrais flics de terrain, disposons d’un sixième sens qui nous permet de savoir instantanément si quelqu’un nous suit ou pas. Cela dit, conscience professionnelle oblige, j’ai fait trois fois le tour du quartier pour m’en assurer. Il me suivait, ou alors quelqu’un le suivait lui aussi et il habitait le même quartier que moi. Mais la plupart des flics, vous le savez comme moi, ont toutes les peines du monde à croire aux coïncidences. Je ne faisais pas exception à la règle.
...
\iconographiewrapfig{r}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_02/_0180_glock-17.jpg}}{Glock 17}
...
Il m’a regardé en serrant les dents, et son visage était aussi chargé de haine que le ciel de Pompéi était chargé de cendres et autres vapeurs toxiques après l’éruption du Vésuve en 79 après J.-C.\nf{Le 24 août 79 apr.~J.-C., le Vésuve entra en éruption et ensevelit sous des tonnes de cendres et de lapilli les villes de Pompéi, Herculanum et Stabies. La catastrophe fut décrite par Pline le Jeune dans deux lettres adressées à Tacite.\source{fr.wikipedia.org/wiki/Éruption\_du\_Vésuve\_en\_79}}
...
%%% \iconographieinlineblock{\bwimage[width=\textwidth]{acte_02/_0420_chicxulub.png}}{Chicxulub}
...
\clearpage
\iconographiedouble[bottom]{acte_02/_0560_la-proie-des-vautours.jpg}{acte_02/_0580_la-comtesse-de-hong-kong.jpg}
