...
{\centering\bwimage[width=\textwidth]{acte_02_note_001_bengale.jpg}\par}
\vspace{0.5\onelineskip}
...
\begin{wrapfigure}{r}{0.33\textwidth}
  \centering
  \bwimage[width=\linewidth]{acte_02_note_002_Marthe_Richard_aviatrice.jpg}\\[0.2em]
  {\scriptsize\itshape Marthe Richard}
\end{wrapfigure}
...
\vspace{0.5\onelineskip}
{\centering\bwimage[width=\textwidth]{acte_02_notes_elonmusk_13_trump_14_poutine_15_bolsonaro_16_meloni17.jpeg}\par}
\vspace{0.5\onelineskip}
...
Le soir même, après une journée de boulot bien remplie comme vous avez pu le constater, je rentrais tranquillement chez moi, avec la satisfaction du devoir accompli, quand je me suis rendu compte que quelque chose clochait dans le périmètre. Dans le rétro de ma Kangoo,  \begin{wrapfigure}{l}{0.50\textwidth}
  \centering
  \bwimage[width=\linewidth]{alfa-romeo-giulietta-noir-alfa-black.png}\\[0.2em]
  {\scriptsize\itshape Alfa Romeo Giulietta}
\end{wrapfigure}plus exactement. Sauf à être devenu complètement parano, ce qui n’était pas impossible vu les cadences infernales auxquelles nous étions soumis, une voiture me suivait. Une Alfa Romeo Giulietta noire aux vitres teintées, le genre de caisse pilotée neuf fois sur dix par une tête à claques qui se prend pour Fangio et finit encastré dans le premier platane qui passe à sa portée. Nous, les vrais flics de terrain, disposons d’un sixième sens qui nous permet de savoir instantanément si quelqu’un nous suit ou pas. Cela dit, conscience professionnelle oblige, j’ai fait trois fois le tour du quartier pour m’en assurer. Il me suivait, ou alors quelqu’un le suivait lui aussi et il habitait le même quartier que moi. Mais la plupart des flics, vous le savez comme moi, ont toutes les peines du monde à croire aux coïncidences. Je ne faisais pas exception à la règle.
...
\begin{wrapfigure}{r}{0.33\textwidth}
  \centering
  \bwimage[width=\linewidth]{acte_02_note_18_glock-17.jpg}\\[0.2em]
  {\scriptsize\itshape Glock 17}
\end{wrapfigure}
...
\vspace{0.5\onelineskip}
{\centering\bwimage[width=\textwidth]{acte_02_note_026_culture-yamna.jpg}\par}
{\centering\scriptsize\itshape Impact génétique de la culture Yamna en Europe.\par}
\vspace{0.5\onelineskip}
...
\begin{wrapfigure}{r}{0.4\textwidth}
  \centering
  \bwimage[width=\linewidth]{acte_02_note_054_ovis-shantungensis.jpeg}\\[0.2em]
  {\scriptsize\itshape Ovis shantungensis}
\end{wrapfigure}
...
\begin{minipage}[t]{0.48\textwidth}
  \bwimage[width=\linewidth]{acte_02_note_056_la-proie-des-vautours.jpg}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
  \raggedleft
  \bwimage[width=\linewidth]{acte_02_note_058_la-comtesse-de-hong-kong.jpg}
\end{minipage}
