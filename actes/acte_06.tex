...
\textsc{Moi} : A Zanzibar, oui, je sais.
...
\textsc{Lui} : Brigadier-chef Darian Lisnic, mon commandant. A vos ordres !
...
\textsc{Moi} : Désolé, Sally, mais je crois que vous avez compris le fond de ma pensée. Au cas où ce ne serait pas le cas, je vous donne ma parole que Tiago Alvarez sera vengé comme il se doit. A ce propos, j’aimerais, si vous le permettez, faire part à l’assemblée d’une petite idée qui m’est venue pour solutionner le problème.
