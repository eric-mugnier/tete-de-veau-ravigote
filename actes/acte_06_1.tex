...
\textsc{Elle}, s’agrippant à mon bras avec l’énergie du désespoir (elle aurait mérité un prix de comédie) : Avec la plus grande joie !

\textsc{Moi} (je n’étais pas mal non plus, entre la tragédie grecque et le théâtre de boulevard) : Dans ce cas, je vais me jeter à corps perdu dans la bataille, et tant pis si je vole au devant d’une mort certaine !
...
\textsc{Moi}, lui dévorant goulûment les lèvres : Mon amour !
...
\textsc{Lui}, découragé : Vu comme ça. Bon, c’est pas grave, de toute façon Sam a pris du rab.
...
\textsc{Moi} (dans le genre mec chiant qui répète tout ce qu’on dit, pose un milliard de fois la même question et ne comprend rien à rien) : T’as pas pris ta voiture ?
...
\illusloflabel{}%
\iconographiewrapfig{r}{0.55\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_10/_0000_peugeot-break-307.png}}{Peugeot 307 break}%
%
\textsc{Lui}, d’une patience d’ange : Oui, trop petit.
...
\textsc{Nathan}, l’œil vif du conducteur toujours sur le qui-vive, au ralenti dans une ruelle à sens unique : Et qu’est-ce qu’il est devenu, ton calmar ?
...
\textsc{Greg}, jetant sur moi un œil chargé de ce qu’il faut bien appeler un doux mélange de réprobation certaine et d’acrimonie à peine dissimulée : Pas de problème.
...
\textsc{Titus} : Non. On mange des plantains frits, de la soupe de gombo\nf{Légume (\textit{Abelmoschus esculentus}) aux siliques mucilagineux, pilier des cuisines d’Afrique de l’Ouest et des Caraïbes (gumbo américain).\source{fr.wikipedia.org/wiki/Gombo}} et de la sauce palabre\nf{Sauce traditionnelle d’Afrique de l’Ouest à base de noix de palme et de feuilles de taro ou d’épinards, aussi appelée sauce graine.\source{fr.wikipedia.org/wiki/Sauce\_graine}} aux feuilles de taro. Quand on mange, parce que la plupart du temps on ne mange pas. La plupart des gens crèvent de faim dans l’indifférence quasi générale, alors tu penses bien qu’on a autre chose à foutre que de s’amuser à découper des calmars en rondelles.
...
Au détour d’une ruelle, aussi sombre et étroite que l’anus d’un ver de terre, une forme venait d’apparaître dans les phares du van.
...
\illusloflabel{Atiena, gardienne de la nuit}
\iconographieinlineblock[t]{\bwimage[width=\textwidth]{acte_06/scene_11/_0000_atiena.jpg}}{}
...
\illusloflabel{Zarah Leander}%
\iconographieinlineblock[b]{\bwimage[width=\textwidth]{acte_06/scene_10/_0840_zarah-leander.jpg}}{Zarah Leander \textup{1907--1981}, dans Paramatta, bagne de femmes \textup{1937} }

\textsc{Nathan} : Et puis ils passent \textit{Bagne de femmes} avec Zarah Leander\nf{Actrice et chanteuse suédoise (1907--1981), vedette du cinéma allemand des années 1930--1940, figure ambiguë de la culture du IIIe Reich.\source{fr.wikipedia.org/wiki/Zarah\_Leander}} à trois heures du mat.
...
\textsc{Atiena}, gardienne de la nuit : \shouting{Titus pas aller !!!}
...
«~\shouting{Titus pas aller, venir avec moi !!!!!!!!!}~»
...
\textsc{Lui}, les yeux injectés de sang, les traits déformés par la haine au point que je ne suis même pas certain que je l’aurais reconnu si je l’avais croisé par hasard dans la rue : M’en vais lui tailler les oreilles en pointe, moi, à cette salope !

\textsc{Atiena} : Moi pas salope. Toi gros porc.

\illusloflabel{Alain Delon, The Taste of France}%
\iconographiewrapfig{r}{0.55\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_11/_0790_alain-delon-the-taste-of-france.jpg}}{}%
...
\textsc{Sam} (qui, maintenant que j’y pense, avait à peu près la même tête de basset que Stallone dans First Blood\nf{Premier film de la saga Rambo (Ted Kotcheff, 1982), avec Sylvester Stallone dans le rôle de John Rambo, vétéran du Vietnam traqué par la police d’une petite ville.\source{fr.wikipedia.org/wiki/First\_Blood}}, cette même tête ayant, avec l’âge et le botox, changé radicalement de physionomie pour ressembler de plus en plus à celle d’un bulldog amateur de cigares) : Vous avez entendu ça, les gars ?
...
\illusloflabel{Casio G-Shock Master of G Rangeman GW-9500-3ER}%
\iconographiewrapfig{l}{0.3\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_11/_0840_casio-g-shock84-master-of-g-rangeman-gw-9500-3er-à-boussole-numérique-et-altimètre-barométrique.png}}{}%
\textsc{Nathan} : Ah bon.
...
\textsc{Nathan}, consultant sa Casio G-Shock\nf{Gamme de montres ultra-robustes de Casio (Japon), lancée en 1983 ; le Rangeman GW-9500 intègre boussole, altimètre et baromètre.\source{fr.wikipedia.org/wiki/Casio\_G-Shock}} Master of G Rangeman GW-9500-3ER à boussole numérique et altimètre barométrique : Tiens, ma montre est en panne. C’est bizarre.

\textsc{Greg} : Faut penser à changer les piles.

\illusloflabel{Baume \& Mercier Classima 10415}%
\iconographiewrapfig{r}{0.3\textwidth}{\bwimage[width=\linewidth]{acte_06/scene_11/_0850_baume-&-mercier-classima-10415.png}}{}%
\textsc{Nathan} : Quelle heure est-il, \foreignlanguage{spanish}{por favor?}

\textsc{Greg}, consultant sa Baume \& Mercier\nf{Manufacture horlogère suisse fondée en 1830, spécialisée dans les montres classiques et habillées.\source{fr.wikipedia.org/wiki/Baume\_et\_Mercier}} Classima 10415, un modèle classique et discret en acier inoxydable étanche à cinquante mètres et bénéficiant de deux ans de garantie : Une heure du mat. Pourquoi ?
...
\illusloflabel{Black Panther Fashionista}%
\iconographieimg[0.9]{acte_06/scene_11/_0550_black-panthers_2.jpg}{Philadelphia Fashion Blogger Vida Fashionista as Black Panther} %
