...
%%% \iconographiewrapfig{r}{0.6\textwidth}{\bwimage[width=\linewidth]{acte_03/_0450_zanzibar.jpg}}{Zanzibar} 
...
C’est à ce moment-là que Virginie, seize ans, qui était dans sa chambre en train de lire le \textit{Traité sur la Musique}\nf{\textit{De Musica}, traité en six livres de saint Augustin (v.~387--391), portant sur le rythme et la métrique musicale~; l’un des rares textes de l’Antiquité tardive à articuler théorie musicale et philosophie néoplatonicienne. \source{fr.wikipedia.org/wiki/Trait\%C3\%A9\_de\_la\_musique}} de saint Augustin\nf{Augustin d’Hippone (354--430), théologien et philosophe latin, évêque d’Hippone (Afrique du Nord)~; l’un des Pères et Docteurs de l’Église les plus influents, auteur des \textit{Confessions} et de \textit{La Cité de Dieu}. \source{fr.wikipedia.org/wiki/Augustin\_d\%27Hippone}} (elle jouait du piano depuis l’âge de dix ans), a fait son apparition dans la cuisine. Elle avait entendu du bruit et tenait à s’enquérir de la situation.
...
%%% \iconographiewrapfig{l}{0.5\textwidth}{\bwimage[width=\linewidth]{acte_03/_0520_george-stinney.jpg}}{George Junius Stinney Jr., 1929--1944} 
...
\iconographieinlineblock[b]{\bwimage[width=0.9\textwidth]{acte_03/_0685_scènes-de-chasse.jpg}}{Salle de la Grande Chasse, Villa romaine du Casale} %%% 
...
%%% \iconographieinlineblock[]{\bwimage[width=\textwidth]{acte_03/_0880_article-122-6-du-code-pénal.jpg}}{}
%%% 
...
\textsc{Moi} : Oui, riz au jasmin et agneau mariné à la sauce hoisin, conçues à l’origine par le grand chef Anada Sintawichai pour Tuani, sa chienne Thaï Ridgeback\nf{Race canine primitive originaire de Thaïlande, se distinguant par une crête de poils inversés le long du dos~; apparentée au Rhodesian Ridgeback et au Phu Quoc, elle figure parmi les races les plus anciennes d’Asie du Sud-Est et se décline en quatre couleurs, dont un rare bleu. \source{fr.wikipedia.org/wiki/Chien\_tha\%C3\%AFlandais\_\%C3\%A0\_cr\%C3\%AAte\_dorsale}} à poil bleu.
