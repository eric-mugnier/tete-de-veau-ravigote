Quelques jours plus tard, les journaux ont parlé d’un corps retrouvé carbonisé dans le coffre d’une voiture, au cœur d’une vaste friche industrielle abandonnée bien connue pour servir de lieu de rendez-vous à toute une faune de pervers qui venaient se tripoter la nouille entre les tas d’immondices.
...
Aujourd’hui âgée de vingt-deux ans, méconnaissable, Jaya multipliait les addictions et n’hésitait pas à se prostituer pour satisfaire ses besoins. Elle avait défoncé toutes les barrières, arraché toutes les digues, pulvérisé tous les cadres. C’est dans ces conditions abominables qu’elle avait croisé la route d’un certain Simon Keskula, fondateur de l’Alliance de la Révélation, secte post-apocalyptique établie au fin fond des Alpes de Haute-Provence, au pied de la Montagne de Lure\nf{Massif montagneux des Alpes de Haute-Provence culminant à 1826~m, à l’est du Luberon. Zone d’isolement extrême, elle abrite le monastère cistercien de Ganagobie et fut longtemps un refuge pour des communautés religieuses en retrait du monde.\source{fr.wikipedia.org/wiki/Montagne\_de\_Lure}}. Keskula, depuis longtemps dans le collimateur de la MIVILUDES\nf{Mission interministérielle de vigilance et de lutte contre les dérives sectaires, créée par décret en mai 2002 auprès du Premier ministre. Elle observe et analyse les mouvements à caractère sectaire et conseille les pouvoirs publics et les particuliers. \source{fr.wikipedia.org/wiki/Miviludes}}, n’en était pas à son coup d’essai, puisqu’on lui devait déjà la création du Monster Gang (une organisation genre X-Men\nf{Franchise de super-héros Marvel créée par Stan Lee et Jack Kirby en 1963, mettant en scène des mutants aux pouvoirs extraordinaires victimes de discrimination. Adaptée au cinéma par Bryan Singer (\textit{X-Men}, 2000 ; \textit{X2}, 2003), la série est souvent lue comme une métaphore des persécutions raciales et de l’homophobie.\source{fr.wikipedia.org/wiki/X-Men}} censée regrouper des gens aux capacités hors du commun) et de l’Ordre de la Lune Noire (structure opaque en relation avec des groupuscules d’extrême droite), tous deux de sinistre mémoire et frappés d’interdiction par les autorités compétentes. Lesquelles, jusqu’à présent, se cassaient les dents sur l’Alliance de la Révélation, qui semblait bénéficier de la protection de certaines personnalités influentes.
...
C’est à ce moment-là que Virginie, seize ans, qui était dans sa chambre en train de lire le \textit{Traité sur la Musique}\nf{\textit{De Musica}, traité en six livres de saint Augustin (v.~387--391), portant sur le rythme et la métrique musicale~; l’un des rares textes de l’Antiquité tardive à articuler théorie musicale et philosophie néoplatonicienne. \source{fr.wikipedia.org/wiki/Traité\_de\_la\_musique}} de saint Augustin\nf{Augustin d’Hippone (354--430), théologien et philosophe latin, évêque d’Hippone (Afrique du Nord)~; l’un des Pères et Docteurs de l’Église les plus influents, auteur des \textit{Confessions} et de \textit{La Cité de Dieu}. \source{fr.wikipedia.org/wiki/Augustin\_d'Hippone}} (elle jouait du piano depuis l’âge de dix ans), a fait son apparition dans la cuisine. Elle avait entendu du bruit et tenait à s’enquérir de la situation.
...
\textsc{Moi} : On avisera. Pour info, j’ai appris récemment que Riqueti est originaire de Spezzano\nf{Spezzano Albanese, Commune de Calabre (province de Cosenza, Italie), peuplée d’environ 7~000 habitants~; l’un des principaux centres historiques de la communauté arbëreshë, minorité d’origine albanaise installée en Italie du Sud au \textsc{xv}\textsuperscript{e}~siècle, conservant la langue et les rites grecs-catholiques. \source{fr.wikipedia.org/wiki/Spezzano\_Albanese}}, le siège du clan Terracciano\nf{Le nom \textit{Terracciano} est sans doute un nom fictif substitué à \textit{Forastefano} par l'auteur. La \textit{'ndrina} Forastefano est l'une des familles les plus puissantes de la \textit{'ndrangheta}, la mafia calabraise. Originaire de Platì (province de Reggio de Calabre), elle est implantée en Italie, au Canada et en Australie, et figure parmi les organisations criminelles les plus riches et les mieux structurées au monde. \source{it.wikipedia.org/wiki/'Ndrina\_Forastefano}}.
...
\textsc{Lui}, levant les yeux au ciel : Oui, un téléphone.
...
\iconographietex{figures/naziporn_fig.tex}
\illusloflabel{}%
\iconographieinlineblock[b]{\bwimage[width=\textwidth]{acte_03/scene_4/_0650_aston-marting-db5.png}}{Aston Martin DB5}
Je ne vous l’ai peut-être pas dit, mais ma caisse, même si elle n’avait pas grand-chose à voir avec l’Aston DB5\nf{Grand tourisme britannique produit par Aston Martin de 1963 à 1965, propulsé par un six cylindres en ligne de 4~litres~; mondialement connue pour avoir été la voiture de James Bond dans \textit{Goldfinger} (1964), elle reste l’automobile la plus emblématique de la saga. \source{fr.wikipedia.org/wiki/Aston\_Martin\_DB5}} de ce crétin de James Bond\nf{Agent secret britannique fictif, matricule 007, créé par Ian Fleming en 1953~; héros d’une série de romans d’espionnage puis d’une franchise cinématographique débutée en 1962 avec \textit{Dr. No}, l’une des plus lucratives de l’histoire du cinéma. \source{fr.wikipedia.org/wiki/James\_Bond}} ou le Tumbler\nf{Surnom du véhicule blindé du super-héros Batman dans la trilogie de Christopher Nolan (\textit{Batman Begins}, 2005~; \textit{The Dark Knight}, 2008~; \textit{The Dark Knight Rises}, 2012)~; conçu par l’équipe de production comme un croisement entre une Lamborghini et un char d’assaut. \source{fr.wikipedia.org/wiki/Batmobile}} de cet autre abruti notoire de Bruce Wayne, était quand même équipée de gadgets très utiles pour sauver ses fesses en cas de coup dur. Par exemple, un jeu de plaques minéralogiques rotatives me permettait de dissimuler ma véritable identité en un battement de cils. Ce tour de force s’effectuait grâce à un interrupteur habilement dissimulé parmi les commandes du tableau de bord, et on ne pouvait espérer détecter la supercherie qu’en se livrant à un examen approfondi des plaques en question. C’était Nathan Lussier (un des nombreux frères de Greg), garagiste de son état, féru de nouvelles technologies et de nazi porn\nf{Le \textit{nazisploitation} est un sous-genre du cinéma d’exploitation apparu dans les années 1970, mêlant imagerie nazie, sadisme et érotisme. Ses titres les plus connus — \textit{Train spécial pour Hitler} (1977), \textit{Ilsa, la louve des SS} (1975), \textit{La Bête en chaleur} (1977) — furent pour la plupart produits en Italie et interdits dans de nombreux pays. \source{fr.wikipedia.org/wiki/Nazisploitation}} (\textit{Train spécial pour Hitler}\nf{Film nazisploitation français réalisé par Alain Payet (sous le pseudonyme James Gartner) et produit par Eurociné (1977)~; l'intrigue se déroule en 1941 et met en scène un train transformé en bordel mobile pour le compte d'officiers nazis sur le front de l'Est. Avec Monica Swinn et Frank Braña.\source{fr.wikipedia.org/wiki/Train\_sp\%C3\%A9cial\_pour\_Hitler}}, \textit{Ilsa la louve des SS}\nf{Film d'exploitation canado-américain réalisé par Don Edmonds (1975), mettant en scène une officière nazie sadique interprétée par Dyanne Thorne~; figure emblématique du nazisploitation.\source{fr.wikipedia.org/wiki/Ilsa,\_la\_louve\_des\_SS}}, \textit{Camp N°7}\nf{\textit{Love Camp 7} (titre original), film nazisploitation américain réalisé par Lee Frost (1969)~; interdit en France de 1972 à 1979 et frappé d’interdiction de commercialisation vidéo au Royaume-Uni.\source{fr.wikipedia.org/wiki/Le\_Camp\_sp\%C3\%A9cial\_no\_7}}, \textit{Le Lac des morts-vivants}\nf{Film d’horreur franco-allemand (1981) réalisé par Jean Rollin et Jean-Marc Gastine, mettant en scène des soldats nazis zombies resurgeant d’un lac alpin pour terroriser un village. Classé parmi les films les plus ratés du cinéma fantastique européen.\source{fr.wikipedia.org/wiki/Le\_Lac\_des\_morts\_vivants}}, autant de chefs-d’œuvre absolus réservés à un public averti), en plus du bel canto (fan de Donizetti\nf{Gaetano Donizetti (1797--1848), compositeur italien du bel canto, auteur de soixante-cinq opéras dont \textit{L’Elisir d’amore} (1832), \textit{Don Pasquale} (1843) et \textit{Lucia di Lammermoor} (1835). Avec Bellini et Rossini, il forma la grande trinité du bel canto romantique. \source{fr.wikipedia.org/wiki/Gaetano\_Donizetti}}, il écoutait \textit{Lucia di Lammermoor}\nf{\textit{Lucia di Lammermoor}, opéra en trois actes de Gaetano Donizetti (livret de Salvadore Cammarano, d’après le roman de Walter Scott), créé au Teatro San Carlo de Naples le 26 septembre 1835. La scène de la folie du dernier acte, pour soprano colorature, est l’une des plus célèbres de tout le répertoire lyrique. \source{fr.wikipedia.org/wiki/Lucia\_di\_Lammermoor}} en boucle en jouant de la pompe à vide et de la clé de 12) et de la chasse à l’arc (c’était son côté comte Zaroff\nf{\textit{Les Chasses du comte Zaroff}, (The Most Dangerous Game) est un film américain réalisé par Ernest B. Schoedsack et Irving Pichel et sorti en 1932. Il s’agit d’une adaptation pour le grand écran d’une nouvelle de Richard Connell, The Most Dangerous Game (1924)}, sauf que lui utilisait un arc à poulies Martin Cougar Vintage MT-6\nf{Arc à poulies (arc compound) de la marque américaine Martin Archery, utilisé par Sylvester Stallone dans \textit{John Rambo} (\textit{Rambo IV}, 2008) pour les scènes d’action à la frontière thaïlando-birmane.\source{martinarchery.com/}} en fibre de carbone, le même que Stallone\nf{Sylvester Stallone (né en 1946), acteur et réalisateur américain, icône du cinéma d’action des années 1980. Connu principalement pour ses rôles de Rocky Balboa et John Rambo, deux franchises qu’il a co-écrites et interprétées sur plusieurs décennies. \source{fr.wikipedia.org/wiki/Sylvester\_Stallone}} dans \textit{John Rambo}\nf{\textit{John Rambo} (2008), quatrième film de la saga \textit{Rambo}, réalisé et interprété par Sylvester Stallone. Rambo y utilise notamment un arc à poulies dans la jungle birmane. Le film se distingue par un niveau de violence particulièrement élevé. \source{fr.wikipedia.org/wiki/John\_Rambo\_(film)}}, quatrième volet de la saga avec un John Rambo qui commence sérieusement à piquer du nez dans sa soupe), qui avait procédé à l’installation avec tout le génie dont il était capable. 

L’optimisation (la plupart du temps, recon\-nais\-sons-le, parfaitement illégale) de véhicules ordinaires était sa grande passion. Par exemple, le moteur à essence 1,6 16v de ma fidèle Kangoo développait à l’origine une petite centaine de poneys. C’était bien suffisant pour doubler un poids lourd et effectuer ses livraisons en temps et en heure, mais totalement ridicule pour espérer se livrer à des courses-poursuites délirantes dans des conditions extrêmes telles que centres-villes aux terrasses bondées et trottoirs encombrés de gens en fauteuil roulant et de mères de familles avec des landaus, autoroutes à contresens ou routes de montagne sinueuses bordées de falaises d’un côté et de précipices de l’autre. Eh bien, croyez-le ou non, mais après être passé entre les mains magiques de Nathan, le bloc pouvait maintenant se prévaloir d’un troupeau de cent cinquante mustangs gonflés à bloc qui piaffaient d’impatience d’exploser les chronos. Grâce à Nathan, l’utilitaire léger était devenu une authentique bombe de l’asphalte. Il avait bien sûr fallu procéder aux aménagements nécessaires en termes de fiabilité et de sécurité (je ne plaisante pas avec ça), mais j’avais insisté pour que rien ne se fasse au détriment de la discrétion exemplaire qui avait toujours été ma règle de conduite : pas d’échappement tonitruant, de roues de camion, aileron de requin et autres prises d’air intempestives. Pour tout le monde, j’étais et devais rester le parfait brave type qui roulait sans accroc, respectait scrupuleusement les limitations de vitesse et les panneaux de signalisation, n’oubliait jamais d’attacher sa ceinture, mettre son clignotant et vérifier la pression de ses pneus avant de partir en vacances (chose qu’il ne faisait bien évidemment jamais vu que son compte en banque était dans le rouge dès le 13 du mois).
...
Et là, franchement, que s’écrier d’autre que (je m’en excuse d’avance auprès de toutes les âmes sensibles et éprises de justice divine que ces paroles pourraient choquer) : \shouting{Nom de dieu de bordel de merde de fils de pute d’enculé de sa race !!!}

\illusloflabel{\textit{Les Chasses du comte Zaroff}}%
\iconographieimg[1]{acte_03/scene_4/_0750_les-chasses-du-comte-zaroff_2.jpg}{Les Chasses du comte Zaroff \textup{1932}\\[-3pt]Fay Wray \textup{1907--2004} · Steve Clemente \textup{1885--1950} · Leslie Banks \textup{1890--1952}}

\scene

\illusloflabel{George Junius Stinney Jr.}%
\iconographieinlineblock[b]{\bwimage[width=0.75\textwidth]{acte_03/scene_5/_0010_george-stinney.jpg}}{George Junius Stinney Jr.\\[-3pt] \textup{1929--1944}}
...
\illusloflabel{}%
\iconographieinlineblock[b]{\bwimage[width=0.9\textwidth]{acte_03/scene_5/_0685_scènes-de-chasse.jpg}}{Villa romaine du Casale, Salle de la Grande Chasse} %%% 
...
\textsc{Riqueti}, voyant que je reluquais son clebs : Je vous présente Terzo, inspecteur. C’est un Cirneco de l’Etna\nf{Le Cirneco dell’Etna est une race de lévrier sicilienne parmi les plus anciennes d’Europe, attestée dès 2 500 av.\ \textsc{j.-c.} par des pièces de monnaie et des mosaïques. La villa romaine du Casale (Piazza Armerina, Sicile, \textsc{iv}e s.), inscrite au patrimoine mondial de l’Unesco, en présente de remarquables représentations de chasse. Aristote le mentionne dans son \textit{Histoire des animaux} (livre IX). \source{fr.wikipedia.org/wiki/Cirneco\_dell'Etna}}, un lévrier de très haute lignée dont on retrouve la trace dès l’Antiquité. En Sicile, par exemple, sur les murs de la villa du Casale\nf{La villa romaine du Casale, à Piazza Armerina (Sicile), est un ensemble palatial du \textsc{iv}\textsuperscript{e}~siècle inscrit au patrimoine mondial de l’Unesco depuis 1997. Elle abrite les plus grandes et mieux conservées mosaïques romaines du monde, sur plus de 3\,500~m². \source{fr.wikipedia.org/wiki/Villa\_romaine\_du\_Casale}} à Chiazza\nf{Chiazza est le nom sicilien de Piazza Armerina, commune du centre de la Sicile (province d’Enna). La ville doit sa célébrité internationale à la villa romaine du Casale, site classé par l’Unesco. \source{fr.wikipedia.org/wiki/Piazza\_Armerina}}, on peut voir des scènes de chasse parfaitement conservées sur lesquelles il figure. Vous noterez la noblesse de ses traits. Aristote\nf{Aristote (384--322 av.\ \textsc{j.-c.}), philosophe grec, élève de Platon et précepteur d’Alexandre le Grand. Fondateur du Lycée à Athènes, il est l’auteur d’une œuvre encyclopédique couvrant la logique, la physique, la biologie, l’éthique et la politique. Son \textit{Histoire des animaux} (en grec~: \textit{Historia Animalium}) décrit quelque cinq cents espèces. \source{fr.wikipedia.org/wiki/Aristote}} lui-même en a fait une description assez convaincante dans son \textit{Histoire des animaux}\nf{\textit{Histoire des animaux} (\textit{Historia Animalium}), traité de zoologie d’Aristote en dix livres (iv\textsuperscript{e}~siècle av.~\textsc{j.-c.})~; première œuvre systématique d’histoire naturelle de l’Antiquité, fondée sur l’observation et la classification d’environ cinq cents espèces. \source{fr.wikipedia.org/wiki/Histoire\_des\_animaux\_(Aristote)}}. Mais je suppose que tout cela vous indiffère.
...
Un certain nombre de petites choses commençaient à tournoyer dans ma cervelle comme des mouches autour d’une charogne. Ce qui m’avait mis la puce à l’oreille, si j’ose dire, c’était le chien. Jusqu’à présent, je n’avais rien trouvé permettant de relier Riqueti au Brain Catcher, mais maintenant j’avais Terzo, chien de race de son état, dont j’imaginais assez bien qu’il n’était pas du genre à bouffer de la pâtée premier prix. Par contre, les croquettes Waterflox à l’agneau et au riz d’Anada Sintawichai, à peu près aussi chères au kilo que le caviar de Beluga\nf{Le béluga (\textit{Huso huso}) est le plus grand esturgeon eurasiatique, pouvant atteindre 6~m et 1~000~kg~; il peuple la mer Caspienne et la mer Noire. Son caviar, extrait d’œufs pouvant représenter 15~\% de son poids, est l’un des plus rares et des plus onéreux au monde. \source{fr.wikipedia.org/wiki/Huso\_huso}} albinos ou la Tuber magnatum piémontaise\nf{La truffe blanche d’Alba (\textit{Tuber magnatum Pico}), récoltée en Piémont et en Istrie entre octobre et décembre, est l’un des produits alimentaires les plus coûteux au monde (jusqu’à 5\,000~€ le kilogramme). Son parfum intense et sa saveur unique en font l’objet d’une vente aux enchères annuelle à Alba.\source{fr.wikipedia.org/wiki/Truffe\_blanche}}, pouvaient fort bien constituer son ordinaire.
...
\illusloflabel{Albert Fish}%
\iconographiewrapfig{r}{0.4\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0130_albert-fish-1903.jpg}}{Albert Fish \\[-3pt] \textup{1870--1936}}%
%
...
Riqueti, en entendant le coup de feu, a eu le mauvais réflexe de tourner la tête.
...
Pourquoi ne pas le dire, au risque de passer pour un crétin sentimental d’une naïveté crasse à la limite de la niaiserie la plus inacceptable, mais il se trouve que j’ai une certaine tendresse pour les animaux. Au même titre que nous, ils font partie de la grande famille du vivant et tâchent de tirer au mieux, avec les moyens rudimentaires dont ils disposent, leur épingle du jeu sadique auquel ils sont contraints de participer. Cela dit, même si je savais fort bien que ce pauvre Terzo agissait davantage comme une machine à tuer décérébrée qu’un authentique criminel dont la seule et unique joie consiste à infliger de la souffrance à ses semblables, je n’allais pas me laisser égorger comme un mouton pendant la fête de l’Aïd. L’instinct de survie n’est-il pas la force principale qui régit notre existence ? Il faut, en permanence, se protéger d’une multitude d’agressions de toutes natures, dont on ne sait jamais trop quand ni comment elles vont nous tomber sur le dos, ce qui tend à générer du stress et de l’angoisse pouvant aller jusqu’à la psychose et la paranoïa (laquelle va nous pousser à détruire ce qui nous entoure à titre préventif, nous chuchoter dans le creux de l’oreille «~tue untel ou untel si tu veux sauver ta peau~»). Les mécanismes de défense sont au cœur de notre activité, et l’être humain, conscient de cette triste réalité, a mis au point un certain nombre de dispositifs très utiles en cas de danger. Et parmi ceux-ci, même si on ne pouvait plus parler à son égard de fleuron de la technologie moderne, le revolver Le Français de Manufrance (ici en modèle de poche 6.35, l’équivalent national du Walther\nf{Carl Walther (1858--1915), armurier allemand, fondateur en 1886 de la manufacture d’armes Carl Walther GmbH à Zella-Mehlis (Thuringe)~; l’entreprise familiale qu’il créa est à l’origine de pistolets célèbres tels que le PP (1929), le PPK (1931) et le P38 (1938). \source{fr.wikipedia.org/wiki/Carl\_Walther}} thuringeois) restait un exemple tout à fait convaincant de l’ingéniosité déployée par l’être humain pour se protéger de l’adversité.

Les deuxième et troisième coups sont partis quasiment coup sur coup, c’est le cas de le dire, et je dois admettre en toute modestie que tous deux %
\illusloflabel{Anubis}%
\iconographiewrapfig{r}{0.28\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0190_anubis.png}}{Anubis}%
ont atteint leur cible, je veux bien sûr parler de ce pauvre Terzo qui ne faisait finalement rien d’autre qu’effectuer son boulot de chien, en toute innocence.

Hélas, tout a une fin, et jamais plus personne ne l’entendrait aboyer, chose qu’il ne faisait de toute façon que très rarement, compte tenu de son pédigrée et son éducation hors pair. C’est avec beaucoup de dignité, après un ultime soubresaut, qu’il a rendu son âme à Anubis\nf{Dieu de la mythologie égyptienne antique, représenté à tête de chacal~; gardien des nécropoles et protecteur des morts, il préside à l’embaumement et à la pesée du cœur dans le jugement des âmes défuntes. \source{fr.wikipedia.org/wiki/Anubis}}, dieu des chiens, auquel il ressemblait d’ailleurs comme deux gouttes d’eau (au même titre que deux espèces très proches, le chien de garenne des Canaries d’une part, redoutable chasseur de lapin s’il en est, et surtout le lévrier de Malte qui serait un descendant direct de Tesem\nf{Le \textit{Tesem} est un type de chien de chasse de l’Égypte ancienne, représenté dès 3000 av.\ \textsc{j.-c.} sur des peintures funéraires. Considéré comme l’ancêtre de plusieurs races modernes (lévrier de Malte, chien de garenne des Canaries), il est associé au dieu Anubis. \source{fr.wikipedia.org/wiki/Tesem}}, le chien de Khéops\nf{Khéops (en égyptien ancien~: \textit{Khoufou}), deuxième pharaon de la \textsc{iv}\textsuperscript{e}~dynastie (vers 2589--2566 av.\ \textsc{j.-c.}), constructeur de la Grande Pyramide de Gizeh, la seule des sept merveilles du monde antique encore debout. \source{fr.wikipedia.org/wiki/Khéops}}, deuxième pharaon de la IVe dynastie dont la pyramide se dresse à Gizeh\nf{Plateau situé en rive ouest du Nil, en face du Caire~; site du plus célèbre complexe funéraire de l’Antiquité, comprenant les trois grandes pyramides de la \textsc{iv}\textsuperscript{e}~dynastie et le Grand Sphinx, classés au patrimoine mondial de l’Unesco. \source{fr.wikipedia.org/wiki/Gizeh}}, non loin de celles de Khéphren\nf{Khéphren (\textit{Khâfré}), quatrième pharaon de la \textsc{iv}\textsuperscript{e}~dynastie (vers 2558--2532 av.\ \textsc{j.-c.}), fils de Khéops. Constructeur de la deuxième pyramide de Gizeh et, selon l’hypothèse la plus répandue, du Grand Sphinx. \source{fr.wikipedia.org/wiki/Khéphren}}, son fils, et Mykérinos\nf{Mykérinos (\textit{Menkaourê}), pharaon de la \textsc{iv}\textsuperscript{e}~dynastie (vers 2532--2503 av.\ \textsc{j.-c.}), fils de Khéphren. Constructeur de la troisième et plus petite des pyramides de Gizeh. Sa triade sculptée (Musée du Caire) est un chef-d’œuvre de la statuaire égyptienne. \source{fr.wikipedia.org/wiki/Mykérinos}}, le fils de son fils).

\illusloflabel{Tesem}%
\iconographiewrapfig{l}{0.5\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0200_tesem.jpg}}{Tesem}%
...
\illusloflabel{}%
Donc, si on s’en tenait aux dimensions des belligérants, la bataille semblait inégale. Sauf que Niccolo était un boxeur hors pair, aussi difficile à toucher qu’une anguille. Titus, après un corps-à-corps viril pendant lequel il avait pu juger de la force hors du commun de son adversaire, \iconographiewrapfig{r}{0.42\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0260_colt-pocket-hammerless.jpg}}{Colt Pocket Hammerless}était néanmoins parvenu à lui faire lâcher son engin (je parle bien sûr de son Smith \& Wesson Bodyguard 380, 380 pour 380 ACP, soit le 9 mm court conçu dès 1903 par le très inventif John Moses Browning\nf{John Moses Browning (1855--1926), armurier américain, l’un des inventeurs les plus prolifiques de l’histoire des armes à feu. Outre la cartouche .380 ACP (1903), il conçut le Colt M1911, le Browning Hi-Power, la mitrailleuse M2 «~Ma Deuce~» et le Winchester Model 1894. \source{fr.wikipedia.org/wiki/John\_Moses\_Browning}} pour équiper le Colt Pocket Hammerless\nf{Pistolet semi-automatique américain conçu par John Moses Browning et fabriqué par Colt de 1903 à 1945~; sans chien apparent (d’où «~Hammerless~»), compact et discret, il fut largement adopté par les forces de l’ordre et les civils comme arme de poche. \source{fr.wikipedia.org/wiki/Colt\_1903/1908\_Pocket\_Hammerless}}). Un Titus, je le rappelle, qui avait lui-même laissé tomber son Glock quelques instants auparavant. 
...
\textsc{Titus} lui a collé le canon du Bodyguard contre la tempe, et il a dit : Bouge pas.
...
\illusloflabel{}%
\iconographiewrapfig{r}{0.6\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0280_thaï-ridgeback.jpg}}{Thai Ridgeback}% 
%
\textsc{Moi} : Oui, riz au jasmin et agneau mariné à la sauce hoisin, conçues à l’origine par le grand chef Anada Sintawichai pour Tuani, sa chienne Thaï Ridgeback\nf{Race canine primitive originaire de Thaïlande, se distinguant par une crête de poils inversés le long du dos~; apparentée au Rhodesian Ridgeback et au Phu Quoc, elle figure parmi les races les plus anciennes d’Asie du Sud-Est et se décline en quatre couleurs, dont un rare bleu. \source{fr.wikipedia.org/wiki/Chien\_thaïlandais\_à\_crête\_dorsale}} à poil bleu.
...
L’avantage, avec le cardinal Riqueti, c’était qu’il était chauve et qu’on pouvait par conséquent s’épargner la corvée de lui raser le crâne avant de le mettre sous tension. Restait maintenant à espérer pour lui que le petit bijou qu’il s’était fait fabriquer fonctionnait aussi bien qu’il l’avait déclaré précédemment, sachant que la chaise\nf{Mode d’exécution inventé aux États-Unis, utilisé pour la première fois en 1890 à Auburn (New York). La Virginie, la Caroline du Sud, le Tennessee et l’Alabama ont eu recours à la chaise électrique dans les dernières décennies ; certains États la proposent encore comme alternative à l’injection létale.\source{fr.wikipedia.org/wiki/Chaise\_électrique}} restait quand même un des instruments de torture les plus barbares jamais mis au point par l’être humain pour se débarrasser de son prochain. À tel point qu’aujourd’hui quasiment plus personne ne l’utilise, à part quelques états parmi les plus %
\illusloflabel{George Dickel Tennessee Whisky}%
\iconographiewrapfig{r}{0.25\textwidth}{\bwimage[width=\linewidth]{acte_03/scene_5/_0310_george-dickel.png}}{}%
sympathiques, les plus accueillants et les moins racistes du territoire américain, je veux bien sûr parler de la Virginie, de la Caroline du Sud, du Tennessee et de l’Alabama, ou griller un Noir de temps à autre fait encore partie des traditions et de ces bons vieux souvenirs qu’on se plaît à évoquer le soir au coin du feu, la pipe au bec et un verre de George Dickel\nf{Marque de whisky du Tennessee fondée dans les années 1870 par George A. Dickel (1818--1894), négociant d’origine allemande établi à Nashville~; la distillerie, située à Cascade Hollow (Tullahoma, Tennessee), est toujours en activité et se distingue du bourbon par une filtration au charbon de bois avant le vieillissement. \source{en.wikipedia.org/wiki/George\_A.\_Dickel}} à la main.
...
\textsc{Moi} : Ce morceau de langue, je ne serais pas étonné que quelqu’un le reçoive bientôt dans sa boîte aux lettres.
...
\illusloflabel{Francis Bacon, \textit{Étude d’après le portrait du pape Innocent X de Velázquez}}%
\iconographieinlineblock[p][2]{\bwimage[width=0.9\textwidth]{acte_03/scene_5/_0000_francis-bacon-study-after-velázquez-s-portrait-of-pope-innocent-x.jpg}}{Francis Bacon · \textup{1909-1992} \\[-3pt] Étude d’après le portrait du pape Innocent X de Velázquez · \textup{1953}}
