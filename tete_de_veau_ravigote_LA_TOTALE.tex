...
\input{tete_de_veau_ravigote_content_etendu.tex}
...
{\centering\normalfont\footnotesize\itshape par ChatGPT de OpenAI, d'après des instructions données par \mbox{Christophe Thiébaud}\par}
\vspace{2\onelineskip}
...
\vspace{0.8\onelineskip}
{\centering\normalfont\footnotesize\itshape par Claude.ai de Anthropic, d'après des instructions données par \mbox{Christophe Thiébaud}\par}
\vspace{2\onelineskip}
{\setlength{\parindent}{0pt}\setlength{\parskip}{\onelineskip}%
