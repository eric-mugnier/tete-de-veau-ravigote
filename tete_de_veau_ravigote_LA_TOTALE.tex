...
{\centering\normalfont\small\itshape par ChatGPT de OpenAI, d'après des instructions données par Christophe Thiébaud\par}
\vspace{2\onelineskip}
{\setlength{\parindent}{0pt}\setlength{\parskip}{2.4\onelineskip}%
...
\vspace{0.8\onelineskip}
{\centering\normalfont\small\itshape par Claude.ai de Anthropic, d'après des instructions données par Christophe Thiébaud\par}
\vspace{2\onelineskip}
{\setlength{\parindent}{0pt}\setlength{\parskip}{2.4\onelineskip}%
