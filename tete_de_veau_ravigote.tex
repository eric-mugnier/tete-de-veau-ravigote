...
\vspace*{\fill}
{\footnotesize\noindent
\hbox to \linewidth{\hfil\tikz\node[opacity=0.33,inner sep=0pt]{\includegraphics[height=1.6\onelineskip]{images/ct_watermark.png}};}\par\vspace{-3pt}
\noindent\rule{\linewidth}{0.4pt}\par\vspace{2pt}
\textcolor{gray}{\noindentÉdition préparée par Christophe Thiebaud\hfill version \docversion\ · \today\ · \gitcommit\ · composé avec pdf\LaTeX}
}
