...
\medskip
\noindent Il est composé de trois ensembles distincts~: 1.~une pseudo-intrigue, effectivement dans un style polar, conduite par le narrateur-héros, Djeferson Beauvais, et agrémentée de nombreuses scènes dialoguées~; 2.~des ratiocinations sans queue ni tête du même héros-narrateur sur les sujets les plus incongrus, le plus souvent des enjeux de société (faire des enfants, les riches et les pauvres, les réseaux sociaux, etc.)~; et 3.~un appareil conséquent de mentions, références et digressions sur des objets culturels ou historiques, passés et contemporains.
