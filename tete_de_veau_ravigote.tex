...
\newfontfamily{\arabicfont}{Geeza Pro}[Script=Arabic]
...
% ═══ ÉPIGRAPHES (p. impaire, avant l'avertissement) ══════════════════════════
\thispagestyle{empty}
\vspace*{\fill}
...
% ═══ AVERTISSEMENT (p. impaire, avant le texte) ══════════════════════════════
\thispagestyle{empty}
\vspace*{4\onelineskip}
{\centering\normalfont\scshape\large Avertissement\par}
\vspace{2\onelineskip}

\noindent Ce que vous allez lire n'est pas un roman. Pas non plus un polar, pas un essai, pas une autofiction, pas un recueil de nouvelles, pas un pamphlet, pas un manuel de savoir-vivre, pas un album pour enfants.

\medskip
\noindent C'est un \textsc{ovni} — objet vittéraire non identifié.

\medskip
\noindent Il est composé de trois types de séquences, qui s'alternent sans logique apparente~: une soit-disant intrigue, dans le style polar, conduite par le héros-narrateur, Djeferson Beauvais, et agrémentée de nombreuses scènes dialoguées~; les ratiocinations sans queue ni tête du même narrateur-héros sur les sujets les plus incongrus, le plus souvent des enjeux de société — faire des enfants, les riches et les pauvres, les réseaux sociaux, etc.~; un appareil conséquent de mentions, références et digressions, qui forment un véritable cabinet de curiosités culturelles et historiques. Le fil rouge de ces trois ensembles me semble être l'Horreur.

\medskip
\noindent L'écrit est inachevé.

\vspace{2\onelineskip}
\begin{flushright}
\normalfont\itshape Christophe Thiebaud, éditeur du manuscrit
\end{flushright}
