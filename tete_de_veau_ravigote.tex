...
% ═══ PAGE BLANCHE (précède le titre) ══════════════════════════════════════════
\hbox{}\thispagestyle{empty}\newpage   % page 1 (impaire) → blanche

% ═══ PAGE DE TITRE (impaire) ══════════════════════════════════════════════════
\cleardoublepage                        % page 2 blanche, atterrit page 3 (impaire)
\begin{center}
...
{\itshape roman}
\end{center}
\cleardoublepage                        % p. 4 blanche (gauche), → p. 5 (impaire/droite)
