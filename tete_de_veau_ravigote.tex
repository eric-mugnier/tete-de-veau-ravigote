...
\medskip
\noindent Il est composé de trois types de séquences, qui s'alternent sans logique apparente~: une pseudo-intrigue, dans le style polar, conduite par le héros-narrateur et agrémentée de nombreuses scènes dialoguées~; les ratiocinations sans queue ni tête du même narrateur-héros sur les sujets les plus incongrus, le plus souvent des enjeux de société — faire des enfants, les riches et les pauvres, les réseaux sociaux, etc.~; et un appareil conséquent de mentions, références et digressions, qui forment un véritable cabinet de curiosités culturelles et historiques. Le fil rouge de ces trois ensembles me semble être l'Horreur.
