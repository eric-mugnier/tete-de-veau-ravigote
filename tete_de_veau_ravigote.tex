...
\makechapterstyle{gallimard}{%
  ...
  \renewcommand{\printchapternum}{%
    \chapnumfont\numberstring{chapter}} % numéro en petites capitales (un, deux…)
...
\vspace*{\fill}
{\footnotesize
\hbox to \linewidth{\hfil\tikz\node[opacity=0.33,inner sep=0pt]{\includegraphics[height=1.6\onelineskip]{images/ct_watermark.png}};}\par\vspace{2pt}
