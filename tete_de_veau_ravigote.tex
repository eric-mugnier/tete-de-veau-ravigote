...
\null\vfill
{\footnotesize
\hbox to \linewidth{\hfil\tikz\node[opacity=0.25,inner sep=0pt]{\includegraphics[height=1.6\onelineskip]{images/ct_watermark.png}};}\par\vspace{-6pt}
\noindent{\color{black!25}\rule{\linewidth}{0.4pt}}\par\vspace{6pt}

% Ligne 1 — justifiée naturellement
\noindent\textit{\docversionordinal\ édition, préparée par Christophe Thiebaud à San Lazzaro di Savena, le \today}\linebreak

% Ligne 2 — logos justifiés gauche / droite
\noindent\colorbox{gray!12.5}{\strut\makebox[\dimexpr \linewidth-2\fboxsep][c]{
\hbox to \linewidth{%
\textup{\LaTeX}
\hfill
\texttt{\docversion\
\hfill
\raisebox{-0.8ex}{\includegraphics[height=3ex]{images/github-repo-git-octocat-svgrepo-com.svg.pdf}}\gitcommit}
