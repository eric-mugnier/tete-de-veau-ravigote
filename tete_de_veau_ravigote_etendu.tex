...
\medskip
\noindent Il est composé de trois types de séquences, qui s'alternent sans logique apparente~: 1. une pseudo-intrigue, dans le style polar, conduite par le héros-narrateur et agrémentée de nombreuses scènes dialoguées~; 2. des ratiocinations sans queue ni tête du même narrateur-héros sur les sujets les plus incongrus, le plus souvent des enjeux de société — faire des enfants, les riches et les pauvres, les réseaux sociaux, etc.~; et 3. un appareil conséquent de mentions, références et digressions, qui forment un véritable cabinet de curiosités historiques et culturelles. Le fil rouge de ces trois ensembles nous semble être l'Horreur.

\medskip
\noindent \textit{L'écrit est inachevé.}
