...
\begin{tikzpicture}[x=1mm, y=1mm, font=\normalfont]
  ...
  % ── Logo CT (1ère, espace libre sous "roman") ─────────────────────────────
  \node[anchor=center, opacity=0.33] at (231, 73)
    {\includegraphics[width=18mm]{images/ct_watermark.png}};
  ...
  \node[anchor=south, opacity=0.33] at (152, 6)
